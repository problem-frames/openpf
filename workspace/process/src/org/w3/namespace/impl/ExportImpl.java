 ...
 * <ul>
 *   <li>{@link org.w3.namespace.impl.ExportImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3.namespace.impl.ExportImpl#getStepName <em>Step Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExportImpl extends EObjectImpl implements Export {
	...
	protected EClass eStaticClass() {
		return NamespacePackage.Literals.EXPORT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NamespacePackage.EXPORT__ID, oldId, id));
	}
	...
	public void setStepName(String newStepName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NamespacePackage.EXPORT__STEP_NAME, oldStepName, stepName));
	}
