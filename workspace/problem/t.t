      <plugin id="Istar2situation"/>
      <plugin id="Istar2situation.ui"/>
      <plugin id="PF2EC"/>
      <plugin id="PF2EC.ui"/>
      <plugin id="antlr.plugin"/>
      <plugin id="argument"/>
      <plugin id="argument.diagram"/>
      <plugin id="argument.diagram.extensions"/>
      <plugin id="argument.edit"/>
      <plugin id="argument.ui"/>
      <plugin id="change"/>
      ...
      <plugin id="dependency.diagram"/>
      <plugin id="dependency.diagram.extensions"/>
      <plugin id="dependency.edit"/>
      <plugin id="dependency.ui"/>
      <plugin id="edu.toronto.cs.openome.conversion"/>
      <plugin id="edu.toronto.cs.openome.evaluation"/>
      <plugin id="edu.toronto.cs.openome.testing"/>
      <plugin id="edu.toronto.cs.openome.versioning"/>
      <plugin id="edu.toronto.cs.openome_model"/>
      <plugin id="edu.toronto.cs.openome_model.diagram"/>
      <plugin id="edu.toronto.cs.openome_model.edit"/>
      <plugin id="edu.toronto.cs.openome_model.editor"/>
      <plugin id="event"/>
      <plugin id="event.ui"/>
      <plugin id="hu.bme.mit.viatra2.viatraDSM.grabats2009live"/>
      <plugin id="hu.bme.mit.viatra2.viatraDSM.skypesim"/>
      <plugin id="hu.optxware.emf2viatra.core"/>
      <plugin id="istar"/>
      <plugin id="istar.diagram.extensions"/>
      <plugin id="istar.generator"/>
      <plugin id="istar.ui"/>
      <plugin id="javax.servlet"/>
      <plugin id="javax.servlet.jsp"/>
      <plugin id="javax.xml"/>
      <plugin id="javax.xml.bind"/>
      <plugin id="laser.flavers.plugin"/>
      <plugin id="laser.juliette.archive"/>
      <plugin id="laser.littlejil"/>
      <plugin id="laser.littlejil.analysis.ui"/>
      <plugin id="laser.littlejil.eclipse.check"/>
      <plugin id="laser.littlejil.eclipse.search"/>
      <plugin id="laser.littlejil.standardtypesplugin"/>
      <plugin id="laser.propel"/>
      <plugin id="laser.visualjil"/>
      <plugin id="laser.visualjil.eclipse.assistants"/>
      <plugin id="laser.visualjil.javabeans"/>
      <plugin id="laser.visualjil.jgrid"/>
      <plugin id="laser.visualjil.jsim"/>
      <plugin id="laser.visualjil.julexporter"/>
      <plugin id="laser.visualjil.julimporter"/>
      <plugin id="laser.visualjil.project"/>
      <plugin id="laser.visualjil.romeo"/>
      <plugin id="laser.visualjil.serialimporter"/>
      <plugin id="laser.visualjil.vsrm"/>
      <plugin id="littlejil.analysis.fsv"/>
      <plugin id="littlejil.analysis.fta"/>
      <plugin id="littlejil.analysis.help"/>
      <plugin id="littlejil.analysis.trace"/>
      <plugin id="littlejil.analysis.trace.visualization"/>
      <plugin id="littlejil.analysis.translator"/>
      <plugin id="lpg.runtime.java"/>
      <plugin id="molhado"/>
      <plugin id="net.sourceforge.lpg.lpgjavaruntime"/>
      <plugin id="ontology"/>
      <plugin id="ontology.edit"/>
      <plugin id="ontology.ui"/>
      <plugin id="openome_model"/>
      <plugin id="openome_model.figures"/>
      ...
      <plugin id="org.eclipse.acceleo.traceability" fragment="true"/>
      <plugin id="org.eclipse.acceleo.traceability.model"/>
      <plugin id="org.eclipse.acceleo.ui.capabilities"/>
      ...
      <plugin id="org.eclipse.emf.mwe.activities"/>
      <plugin id="org.eclipse.emf.mwe.core"/>
      <plugin id="org.eclipse.emf.mwe.ui"/>
      <plugin id="org.eclipse.emf.mwe.ui.simpleEditor"/>
      ...
      <plugin id="org.eclipse.mylyn.commons.xmlrpc"/>
      ...
      <plugin id="org.eclipse.viatra2.core2"/>
      <plugin id="org.eclipse.viatra2.editor"/>
      <plugin id="org.eclipse.viatra2.editor.text"/>
      <plugin id="org.eclipse.viatra2.gtasm.interpreter"/>
      <plugin id="org.eclipse.viatra2.gtasm.interpreter.impl"/>
      <plugin id="org.eclipse.viatra2.gtasm.interpreter.term"/>
      <plugin id="org.eclipse.viatra2.gtasm.model"/>
      <plugin id="org.eclipse.viatra2.gtasm.patternmatcher"/>
      <plugin id="org.eclipse.viatra2.gtasm.patternmatcher.impl"/>
      <plugin id="org.eclipse.viatra2.gtasm.patternmatcher.incremental"/>
      <plugin id="org.eclipse.viatra2.gtasm.patternmatcher.incremental.rete"/>
      <plugin id="org.eclipse.viatra2.gtasm.trigger"/>
      <plugin id="org.eclipse.viatra2.gtasm.typing.model"/>
      <plugin id="org.eclipse.viatra2.gui"/>
      <plugin id="org.eclipse.viatra2.gui.patterns"/>
      <plugin id="org.eclipse.viatra2.help"/>
      <plugin id="org.eclipse.viatra2.imports.uml2.galileo"/>
      <plugin id="org.eclipse.viatra2.imports.vtml"/>
      <plugin id="org.eclipse.viatra2.loaders.vtcl_lpgparser"/>
      <plugin id="org.eclipse.viatra2.natives.strings"/>
      <plugin id="org.eclipse.viatra2.viatraDSM"/>
      <plugin id="org.eclipse.viatra2.viatraDSM.demo"/>
      <plugin id="org.eclipse.viatra2.viatraDSM.gmf"/>
      <plugin id="org.eclipse.viatra2.visualisation"/>
      ...
      <plugin id="org.eclipse.xpand.ui"/>
      ...
      <plugin id="pf2situation"/>
      <plugin id="pf2situation.ui"/>
      <plugin id="problem"/>
      <plugin id="problem.diagram"/>
      <plugin id="problem.diagram.extensions"/>
      <plugin id="problem.edit"/>
      <plugin id="problem.editor"/>
      <plugin id="problem.generator"/>
      <plugin id="problem.ui"/>
      <plugin id="process"/>
      <plugin id="process.edit"/>
      <plugin id="process.editor"/>
      <plugin id="q7"/>
      <plugin id="situation"/>
      <plugin id="situation.diagram"/>
      <plugin id="situation.diagram.extensions"/>
      <plugin id="situation.edit"/>
      <plugin id="situation.editor"/>
      <plugin id="situation.generator"/>
      <plugin id="situation.ui"/>
      <plugin id="uncal"/>
      <plugin id="uncal.generator"/>
      <plugin id="uncal.ui"/>
      <plugin id="util"/>
