package filesystem.diagram.application;
...
import filesystem.diagram.part.FilesystemCreationWizard;
...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			FilesystemCreationWizard wizard = new FilesystemCreationWizard();
