...
import filesystem.diagram.providers.FilesystemValidationDecoratorProvider;
...
public class ValidateAction extends Action {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		FilesystemValidationDecoratorProvider.refreshDecorators(view);
		for (Iterator it = view.eAllContents(); it.hasNext();) {
			EObject next = (EObject) it.next();
			if (next instanceof View) {
				FilesystemValidationDecoratorProvider
