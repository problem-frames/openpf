...
public class FilesystemNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	private filesystem.diagram.application.WizardNewFileCreationPage myFileCreationPage;
	...
	public FilesystemNewDiagramFileWizard(URI domainModelURI,
		...
		myFileCreationPage = new filesystem.diagram.application.WizardNewFileCreationPage(
