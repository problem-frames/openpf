...
import uk.ac.open.dependency.dependency.diagram.edit.commands.NodeCreateCommand;
...
public class ModelItemSemanticEditPolicy extends
	...
	public ModelItemSemanticEditPolicy() {
		super(DependencyElementTypes.Model_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DependencyElementTypes.Node_2001 == req.getElementType()) {
