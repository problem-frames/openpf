...
import uk.ac.open.dependency.dependency.diagram.edit.policies.ModelCanonicalEditPolicy;
import uk.ac.open.dependency.dependency.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Dependency"; //$NON-NLS-1$
