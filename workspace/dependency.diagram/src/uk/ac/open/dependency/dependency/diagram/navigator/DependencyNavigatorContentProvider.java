 ...
 * @generated
 */
public class DependencyNavigatorContentProvider implements
	...
	public DependencyNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<DependencyNavigatorItem> result = new ArrayList<DependencyNavigatorItem>();
		...
		if (parentElement instanceof DependencyNavigatorGroup) {
			DependencyNavigatorGroup group = (DependencyNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof DependencyNavigatorItem) {
			DependencyNavigatorItem navigatorItem = (DependencyNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case PrecedenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DependencyNavigatorGroup target = new DependencyNavigatorGroup(
					Messages.NavigatorGroupName_Precedence_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DependencyNavigatorGroup source = new DependencyNavigatorGroup(
					Messages.NavigatorGroupName_Precedence_4002_source,
		...
		case CouplingEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DependencyNavigatorGroup target = new DependencyNavigatorGroup(
					Messages.NavigatorGroupName_Coupling_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DependencyNavigatorGroup source = new DependencyNavigatorGroup(
					Messages.NavigatorGroupName_Coupling_4001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DependencyVisualIDRegistry.getType(NodeEditPart.VISUAL_ID));
		...
		case NodeEditPart.VISUAL_ID: {
			LinkedList<DependencyAbstractNavigatorItem> result = new LinkedList<DependencyAbstractNavigatorItem>();
			Node sv = (Node) view;
			DependencyNavigatorGroup incominglinks = new DependencyNavigatorGroup(
					Messages.NavigatorGroupName_Node_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DependencyNavigatorGroup outgoinglinks = new DependencyNavigatorGroup(
	 ...
	 * @generated
	 */
	private Collection<DependencyNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<DependencyNavigatorItem> result = new ArrayList<DependencyNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new DependencyNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof DependencyAbstractNavigatorItem) {
			DependencyAbstractNavigatorItem abstractNavigatorItem = (DependencyAbstractNavigatorItem) element;
