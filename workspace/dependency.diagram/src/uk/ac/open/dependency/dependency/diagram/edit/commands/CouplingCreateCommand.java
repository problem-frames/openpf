 ...
 * @generated
 */
public class CouplingCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CouplingCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return DependencyBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCoupling_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Coupling newElement = DependencyFactory.eINSTANCE.createCoupling();
	 ...
	 * @generated
	 */
	protected void doConfigure(Coupling newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
