 ...
 * @generated
 */
public class DependencyViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = DependencyVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = DependencyVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!DependencyElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != DependencyVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = DependencyVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != DependencyVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = DependencyVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case NodeEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (DependencyVisualIDRegistry.getVisualID(elementTypeHint)) {
		case CouplingEditPart.VISUAL_ID:
			return createCoupling_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case PrecedenceEditPart.VISUAL_ID:
			return createPrecedence_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	...
	public Node createNode_2001(EObject domainElement, View containerView,
		...
		node.setType(DependencyVisualIDRegistry.getType(NodeEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createCoupling_4001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(DependencyVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createPrecedence_4002(EObject domainElement,
