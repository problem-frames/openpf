 ...
 * @generated
 */
public class CouplingReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CouplingReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Coupling) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DependencyBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCoupling_4001(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Model container = (Model) getLink().eContainer();
		return DependencyBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCoupling_4001(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Coupling getLink() {
		return (Coupling) getElementToEdit();
	}
