...
import uk.ac.open.dependency.dependency.diagram.edit.policies.DependencyTextSelectionEditPolicy;
...
public class NodeNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new DependencyTextSelectionEditPolicy());
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof DependencyTextSelectionEditPolicy) {
			((DependencyTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof DependencyTextSelectionEditPolicy) {
			((DependencyTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DependencyParserProvider
					.getParser(
							DependencyElementTypes.Node_2001,
							getParserElement(),
							DependencyVisualIDRegistry
									.getType(uk.ac.open.dependency.dependency.diagram.edit.parts.NodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					DependencyEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
