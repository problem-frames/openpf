...
//	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DependencyVisualIDRegistry
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(DependencyElementTypes.Coupling_4001);
		types.add(DependencyElementTypes.Precedence_4002);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof uk.ac.open.dependency.dependency.diagram.edit.parts.NodeEditPart) {
			types.add(DependencyElementTypes.Coupling_4001);
		}
		if (targetEditPart instanceof uk.ac.open.dependency.dependency.diagram.edit.parts.NodeEditPart) {
			types.add(DependencyElementTypes.Precedence_4002);
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == DependencyElementTypes.Coupling_4001) {
			types.add(DependencyElementTypes.Node_2001);
		} else if (relationshipType == DependencyElementTypes.Precedence_4002) {
			types.add(DependencyElementTypes.Node_2001);
		}
		return types;
	}
