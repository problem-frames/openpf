 ...
 *******************************************************************************/
package org.eclipse.acceleo.module.sample.files;
...
/**
 * Entry point of the 'GenerateCopy' generation module.
 * 
 * @author <a href="mailto:jonathan.musset@obeo.fr">Jonathan Musset</a>
 */
public class GenerateCopy {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateCopy";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateCopy", };
	 ...
	 * @generated
	 */
	public GenerateCopy(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(GenerateCopy.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = GenerateCopy.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public GenerateCopy(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    resourceSet.getPackageRegistry().put(uk.ac.open.problem.ProblemPackage.eINSTANCE.getNsURI(), uk.ac.open.problem.ProblemPackage.eINSTANCE);
    ...
    try {
      if (args.length < 2) {
        ...
        GenerateCopy generator = new GenerateCopy(modelURI, folder, arguments);
