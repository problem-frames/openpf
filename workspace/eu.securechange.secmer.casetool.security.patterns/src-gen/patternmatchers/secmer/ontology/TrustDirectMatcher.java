/*******************************************************************************
 * EMF Specific API of the secmer.ontology.trustDirect pattern
...
import signatures.secmer.ontology.TrustDirectSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.trustDirect pattern
 */
public class TrustDirectMatcher extends BaseGeneratedMatcher<TrustDirectSignature> implements IncQueryMatcher<TrustDirectSignature>{
	 ...
	 */
	public Collection<TrustDirectSignature> getAllMatchesAsObject(Object Act1, Object Act2, Object Dependum) {
	 ...
	 */
	public TrustDirectSignature getOneMatchAsObject(Object Act1, Object Act2, Object Dependum) {
	...
	public String getPatternName() {
		return "secmer.ontology.trustDirect";
	}
	...
	protected TrustDirectSignature tupleToSignature(Tuple t) {
		return new TrustDirectSignature(t.get(0), t.get(1), t.get(2));
	}
	...
	public TrustDirectSignature arrayToSignature(Object[] signature) {
		return new TrustDirectSignature(signature[0], signature[1], signature[2]);
	}	
