/*******************************************************************************
 * EMF Specific API of the secmer.ontology.confidentialitySecurityGoal pattern
...
import signatures.secmer.ontology.ConfidentialitySecurityGoalSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.confidentialitySecurityGoal pattern
 */
public class ConfidentialitySecurityGoalMatcher extends BaseGeneratedMatcher<ConfidentialitySecurityGoalSignature> implements IncQueryMatcher<ConfidentialitySecurityGoalSignature>{
	 ...
	 */
	public ConfidentialitySecurityGoalMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ConfidentialitySecurityGoalMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ConfidentialitySecurityGoalMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ConfidentialitySecurityGoalMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * Returns the set of all pattern matches given some fixed parameters.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return matches represented as a ConfidentialitySecurityGoalSignature object.
	 */
	public Collection<ConfidentialitySecurityGoalSignature> getAllMatchesAsObject(Object Goal) {
	 ...
	 * Neither determinism nor randomness of selection is guaranteed.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return a match represented as a ConfidentialitySecurityGoalSignature object, or null if no match is found.
	 */
	public ConfidentialitySecurityGoalSignature getOneMatchAsObject(Object Goal) {
	...
	public String getPatternName() {
		return "secmer.ontology.confidentialitySecurityGoal";
	}
	 ...
	 */
	@Override
	protected ConfidentialitySecurityGoalSignature tupleToSignature(Tuple t) {
		return new ConfidentialitySecurityGoalSignature(t.get(0));
	}
	 ...
	 */
	@Override
	public ConfidentialitySecurityGoalSignature arrayToSignature(Object[] signature) {
		return new ConfidentialitySecurityGoalSignature(signature[0]);
	}	
