/*******************************************************************************
 * EMF Specific API of the secmer.ontology.securityGoal pattern
...
import signatures.secmer.ontology.SecurityGoalSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.securityGoal pattern
 */
public class SecurityGoalMatcher extends BaseGeneratedMatcher<SecurityGoalSignature> implements IncQueryMatcher<SecurityGoalSignature>{
	 ...
	 */
	public SecurityGoalMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public SecurityGoalMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public SecurityGoalMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public SecurityGoalMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * Returns the set of all pattern matches given some fixed parameters.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return matches represented as a SecurityGoalSignature object.
	 */
	public Collection<SecurityGoalSignature> getAllMatchesAsObject(Object Goal) {
	 ...
	 * Neither determinism nor randomness of selection is guaranteed.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return a match represented as a SecurityGoalSignature object, or null if no match is found.
	 */
	public SecurityGoalSignature getOneMatchAsObject(Object Goal) {
	...
	public String getPatternName() {
		return "secmer.ontology.securityGoal";
	}
	 ...
	 */
	@Override
	protected SecurityGoalSignature tupleToSignature(Tuple t) {
		return new SecurityGoalSignature(t.get(0));
	}
	 ...
	 */
	@Override
	public SecurityGoalSignature arrayToSignature(Object[] signature) {
		return new SecurityGoalSignature(signature[0]);
	}	
