/*******************************************************************************
 * EMF Specific API of the secmer.ontology.delegation pattern
...
import signatures.secmer.ontology.DelegationSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.delegation pattern
 */
public class DelegationMatcher extends BaseGeneratedMatcher<DelegationSignature> implements IncQueryMatcher<DelegationSignature>{
	 ...
	 */
	public DelegationMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DelegationMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DelegationMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DelegationMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @param Dependum the fixed value of pattern parameter Dependum, or null if not bound.
	 * @return matches represented as a DelegationSignature object.
	 */
	public Collection<DelegationSignature> getAllMatchesAsObject(Object Act1, Object Act2, Object Dependum) {
	 ...
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @param Dependum the fixed value of pattern parameter Dependum, or null if not bound.
	 * @return a match represented as a DelegationSignature object, or null if no match is found.
	 */
	public DelegationSignature getOneMatchAsObject(Object Act1, Object Act2, Object Dependum) {
	...
	public String getPatternName() {
		return "secmer.ontology.delegation";
	}
	 ...
	 */
	@Override
	protected DelegationSignature tupleToSignature(Tuple t) {
		return new DelegationSignature(t.get(0), t.get(1), t.get(2));
	}
	 ...
	 */
	@Override
	public DelegationSignature arrayToSignature(Object[] signature) {
		return new DelegationSignature(signature[0], signature[1], signature[2]);
	}	
