/*******************************************************************************
 * EMF Specific pattern signature of the secmer.ontology.delegationDirect pattern
...
/**
 * Domain specific Data transfer Object of the secmer.ontology.delegationDirect pattern.
 ...
 */
public class DelegationDirectSignature implements IPatternSignature {

	//constructor
	public DelegationDirectSignature(Object Act1, Object Act2, Object DependencyType, Object Dependum) {
		this.Act1 = Act1;
		this.Act2 = Act2;
	...
	//private attributes
	private Object Act1;	private Object Act2;	private Object DependencyType;	private Object Dependum;
	...
	public void setDependencyType(Object DependencyType){
		 this.DependencyType=DependencyType;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DelegationDirectSignature other = (DelegationDirectSignature) obj;
		...
		if (DependencyType == null) {if (other.DependencyType != null) return false;}
		else if (!DependencyType.equals(other.DependencyType)) return false;
	...
	public String toString(){
		...
		String _temp = " A(n) delegationDirect signature object ("+hashCode()+")\n";
		...
		// Checks that DependencyType has a name attribute and uses if it has 
		_temp += "\tDependencyType = ";
		feature = null;
		if(DependencyType instanceof EObject)
			feature = ((EObject)DependencyType).eClass().getEStructuralFeature("name");

		if(feature != null && ((EObject)DependencyType).eGet(feature) != null) _temp += ((EObject)DependencyType).eGet(feature).toString();
		else _temp += DependencyType.toString();
		_temp += "\n";
	...
	public Object[] toArray() {
		return new Object[] {Act1, Act2, DependencyType, Dependum};
	}
}
