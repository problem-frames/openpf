...
public class PatternBuilderForgoal implements IStatelessGeneratedRetePatternBuilder {
	...
	public Address<? extends Receiver> construct(
		...
		final Address<? extends Receiver> var_330 = buildable.patternCollector("secmer.ontology.goal");
		final Stub<Address<? extends Supplier>> var_331 = buildable.buildStartStub(new Object[] {}, new Object[] {});
		final Object var_332 = EPackage.Registry.INSTANCE.getEPackage("http://securechange.eu/ontology").getEClassifier("Requirement");
		final Stub<Address<? extends Supplier>> var_333 = buildable.unaryTypeStub(new FlatTuple(new Object[] {"Goal"}), var_332);
