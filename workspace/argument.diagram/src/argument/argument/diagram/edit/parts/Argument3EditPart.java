...
import argument.argument.diagram.edit.policies.Argument3ItemSemanticEditPolicy;
import argument.argument.diagram.edit.policies.OpenDiagramEditPolicy;
...
public class Argument3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ArgumentNameDescriptionRound3EditPart) {
			((ArgumentNameDescriptionRound3EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof argument.argument.diagram.edit.parts.Argument3EditPart) {
			types.add(ArgumentElementTypes.Rebuts_4001);
		}
		if (targetEditPart instanceof ArgumentEditPart) {
			types.add(ArgumentElementTypes.Mitigates_4002);
