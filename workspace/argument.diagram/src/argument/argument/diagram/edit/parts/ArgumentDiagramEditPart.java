...
import argument.argument.diagram.edit.commands.ArgumentCreateShortcutDecorationsCommand;
import argument.argument.diagram.edit.policies.ArgumentDiagramCanonicalEditPolicy;
import argument.argument.diagram.edit.policies.ArgumentDiagramItemSemanticEditPolicy;
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new ArgumentCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
