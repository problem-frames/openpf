...
import argument.argument.diagram.edit.policies.Argument2ItemSemanticEditPolicy;
...
public class Argument2EditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof argument.argument.diagram.edit.parts.Argument2EditPart) {
			types.add(ArgumentElementTypes.Rebuts_4001);
		}
