 ...
 * @generated
 */
public class MitigatesRestoresReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MitigatesRestoresReorientCommand(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setRestores(null);
		getNewSource().setRestores(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setRestores(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
