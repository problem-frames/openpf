...
public class MitigatesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final ArgumentDiagram container;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Mitigates newElement = ArgumentFactory.eINSTANCE.createMitigates();
	 ...
	 * @generated
	 */
	protected void doConfigure(Mitigates newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
	 ...
	 * @generated
	 */
	public ArgumentDiagram getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static ArgumentDiagram deduceContainer(EObject source,
			EObject target) {
		...
		for (EObject element = source; element != null; element = element
			...
			if (element instanceof ArgumentDiagram) {
				return (ArgumentDiagram) element;
			}
		}
		return null;
	}
