 ...
 * @generated
 */
public class ArgumentReplacesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentReplacesReorientCommand(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setReplaces(null);
		getNewSource().setReplaces(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setReplaces(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
