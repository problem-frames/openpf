 ...
 * @generated
 */
public class ArgumentElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ArgumentElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ArgumentElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "argument".equals(fileExtension); //$NON-NLS-1$
	}
