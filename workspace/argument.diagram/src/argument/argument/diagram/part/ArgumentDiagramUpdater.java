...
public class ArgumentDiagramUpdater {
	...
	public static List<ArgumentLinkDescriptor> getArgument_2001ContainedLinks(
		...
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Argument_Replaces_4005(modelElement));
		return result;
	}
	...
	public static List<ArgumentLinkDescriptor> getRebuts_4001ContainedLinks(
		...
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Rebuts_Denies_4003(modelElement));
		return result;
	}
	...
	public static List<ArgumentLinkDescriptor> getMitigates_4002ContainedLinks(
		...
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Mitigates_Restores_4004(modelElement));
		return result;
	}
	...
	public static List<ArgumentLinkDescriptor> getArgument_2001IncomingLinks(
		...
		result.addAll(getIncomingFeatureModelFacetLinks_Rebuts_Denies_4003(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Mitigates_Restores_4004(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Argument_Replaces_4005(
				modelElement, crossReferences));
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getIncomingFeatureModelFacetLinks_Rebuts_Denies_4003(
			Argument target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == ArgumentPackage.eINSTANCE
				...
				result.add(new ArgumentLinkDescriptor(setting.getEObject(),
						target, ArgumentElementTypes.RebutsDenies_4003,
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getIncomingFeatureModelFacetLinks_Mitigates_Restores_4004(
			Argument target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == ArgumentPackage.eINSTANCE
				...
				result.add(new ArgumentLinkDescriptor(setting.getEObject(),
						target, ArgumentElementTypes.MitigatesRestores_4004,
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getIncomingFeatureModelFacetLinks_Argument_Replaces_4005(
			Argument target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == ArgumentPackage.eINSTANCE
				...
				result.add(new ArgumentLinkDescriptor(setting.getEObject(),
						target, ArgumentElementTypes.ArgumentReplaces_4005,
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getOutgoingFeatureModelFacetLinks_Rebuts_Denies_4003(
			Rebuts source) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		...
		result.add(new ArgumentLinkDescriptor(source, destination,
				ArgumentElementTypes.RebutsDenies_4003,
				RebutsDeniesEditPart.VISUAL_ID));
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getOutgoingFeatureModelFacetLinks_Mitigates_Restores_4004(
			Mitigates source) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		...
		result.add(new ArgumentLinkDescriptor(source, destination,
				ArgumentElementTypes.MitigatesRestores_4004,
				MitigatesRestoresEditPart.VISUAL_ID));
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getOutgoingFeatureModelFacetLinks_Argument_Replaces_4005(
			Argument source) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		...
		result.add(new ArgumentLinkDescriptor(source, destination,
				ArgumentElementTypes.ArgumentReplaces_4005,
				ArgumentReplacesEditPart.VISUAL_ID));
		return result;
	}
