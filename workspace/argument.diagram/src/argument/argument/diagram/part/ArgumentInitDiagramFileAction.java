 ...
 * @generated
 */
public class ArgumentInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ArgumentNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ArgumentDiagramEditPart.MODEL_ID));
		ArgumentDiagramEditorUtil.runWizard(getShell(), wizard,
