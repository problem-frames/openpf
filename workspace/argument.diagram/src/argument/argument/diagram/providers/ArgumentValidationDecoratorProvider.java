...
import argument.argument.diagram.part.ArgumentDiagramEditor;
 ...
 * @generated
 */
public class ArgumentValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = ArgumentDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ArgumentDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ArgumentDiagramEditPart.MODEL_ID
						.equals(ArgumentVisualIDRegistry.getModelID(view));
	}
