...
public class ArgumentDiagramUpdater {
	...
	public static List<ArgumentNodeDescriptor> getArgumentDiagram_1000SemanticChildren(
		...
		argument.argument.ArgumentDiagram modelElement = (argument.argument.ArgumentDiagram) view
				.getElement();
	...
	public static List<ArgumentLinkDescriptor> getArgument_2001ContainedLinks(
		...
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Argument_Origin_4005(modelElement));
		return result;
	}
	...
	public static List<ArgumentLinkDescriptor> getRebuts_4001ContainedLinks(
			View view) {
		argument.argument.Rebuts modelElement = (argument.argument.Rebuts) view.getElement();
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		result.addAll(getOutgoingFeatureModelFacetLinks_Rebuts_Origin_4003(modelElement));
		return result;
	}
	...
	public static List<ArgumentLinkDescriptor> getMitigates_4002ContainedLinks(
			View view) {
		argument.argument.Mitigates modelElement = (argument.argument.Mitigates) view
				.getElement();
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
	...
	public static List<ArgumentLinkDescriptor> getArgument_2001IncomingLinks(
		...
		result.addAll(getIncomingFeatureModelFacetLinks_Rebuts_Origin_4003(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Mitigates_Rebuttal_4004(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Argument_Origin_4005(
				modelElement, crossReferences));
		return result;
	}
	...
	private static Collection<ArgumentLinkDescriptor> getContainedTypeModelFacetLinks_Rebuts_4001(
			argument.argument.ArgumentDiagram container) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		for (Iterator<?> links = container.getLinks().iterator(); links
				.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof argument.argument.Rebuts) {
				continue;
			}
			argument.argument.Rebuts link = (argument.argument.Rebuts) linkObject;
	...
	private static Collection<ArgumentLinkDescriptor> getContainedTypeModelFacetLinks_Mitigates_4002(
		...
		for (Iterator<?> links = container.getLinks().iterator(); links
				.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof argument.argument.Mitigates) {
				continue;
			}
			argument.argument.Mitigates link = (argument.argument.Mitigates) linkObject;
	...
	private static Collection<ArgumentLinkDescriptor> getIncomingTypeModelFacetLinks_Rebuts_4001(
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != argument.argument.ArgumentPackage.eINSTANCE
					.getLink_To()
					|| false == setting.getEObject() instanceof argument.argument.Rebuts) {
				continue;
			}
			argument.argument.Rebuts link = (argument.argument.Rebuts) setting.getEObject();
			if (RebutsEditPart.VISUAL_ID != ArgumentVisualIDRegistry
					.getLinkWithClassVisualID(link)) {
				continue;
			}
	...
	private static Collection<ArgumentLinkDescriptor> getIncomingTypeModelFacetLinks_Mitigates_4002(
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != argument.argument.ArgumentPackage.eINSTANCE
					.getLink_To()
					|| false == setting.getEObject() instanceof argument.argument.Mitigates) {
				continue;
			}
			argument.argument.Mitigates link = (argument.argument.Mitigates) setting.getEObject();
			if (MitigatesEditPart.VISUAL_ID != ArgumentVisualIDRegistry
					.getLinkWithClassVisualID(link)) {
				continue;
			}
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getIncomingFeatureModelFacetLinks_Rebuts_Origin_4003(
			Argument target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == argument.argument.ArgumentPackage.eINSTANCE
				...
				result.add(new ArgumentLinkDescriptor(setting.getEObject(),
						target, ArgumentElementTypes.RebutsOrigin_4003,
						RebutsOriginEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getIncomingFeatureModelFacetLinks_Argument_Origin_4005(
			Argument target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == argument.argument.ArgumentPackage.eINSTANCE
					.getArgument_Origin()) {
				result.add(new ArgumentLinkDescriptor(setting.getEObject(),
						target, ArgumentElementTypes.ArgumentOrigin_4005,
	...
	private static Collection<ArgumentLinkDescriptor> getOutgoingTypeModelFacetLinks_Rebuts_4001(
			Argument source) {
		argument.argument.ArgumentDiagram container = null;
		// Find container element for the link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
		for (EObject element = source; element != null && container == null; element = element
				.eContainer()) {
			if (element instanceof argument.argument.ArgumentDiagram) {
				container = (argument.argument.ArgumentDiagram) element;
			}
		}
		if (container == null) {
			return Collections.emptyList();
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getOutgoingFeatureModelFacetLinks_Rebuts_Origin_4003(
			argument.argument.Rebuts source) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
	...
	private static Collection<ArgumentLinkDescriptor> getOutgoingFeatureModelFacetLinks_Mitigates_Rebuttal_4004(
			argument.argument.Mitigates source) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
	 ...
	 * @generated
	 */
	private static Collection<ArgumentLinkDescriptor> getOutgoingFeatureModelFacetLinks_Argument_Origin_4005(
			Argument source) {
		LinkedList<ArgumentLinkDescriptor> result = new LinkedList<ArgumentLinkDescriptor>();
		Argument destination = source.getOrigin();
		if (destination == null) {
