...
public class MitigatesReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof argument.argument.Mitigates) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected argument.argument.Mitigates getLink() {
		return (argument.argument.Mitigates) getElementToEdit();
	}
