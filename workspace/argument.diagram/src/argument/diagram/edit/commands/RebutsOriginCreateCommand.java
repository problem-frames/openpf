 ...
 * @generated
 */
public class RebutsOriginCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RebutsOriginCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof argument.argument.Rebuts) {
			return false;
		}
		...
		return ArgumentBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRebutsOrigin_4003(getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected argument.argument.Rebuts getSource() {
		return (argument.argument.Rebuts) source;
	}
