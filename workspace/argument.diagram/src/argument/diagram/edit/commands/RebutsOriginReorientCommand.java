...
public class RebutsOriginReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof argument.argument.Rebuts) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Argument && newEnd instanceof argument.argument.Rebuts)) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected argument.argument.Rebuts getOldSource() {
		return (argument.argument.Rebuts) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected argument.argument.Rebuts getNewSource() {
		return (argument.argument.Rebuts) newEnd;
	}
