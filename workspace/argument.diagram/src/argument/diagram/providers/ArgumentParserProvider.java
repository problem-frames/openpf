...
import argument.diagram.parsers.MessageFormatParser;
	...
	private IParser getArgumentNameDescriptionRound_5003Parser() {
		if (argumentNameDescriptionRound_5003Parser == null) {
			EAttribute[] features = new EAttribute[] {
					argument.argument.ArgumentPackage.eINSTANCE.getArgument_Name(),
					argument.argument.ArgumentPackage.eINSTANCE
							.getArgument_Description(),
					argument.argument.ArgumentPackage.eINSTANCE.getArgument_Round() };
