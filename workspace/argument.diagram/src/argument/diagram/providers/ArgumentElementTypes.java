	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ArgumentDiagram_1000,
					argument.argument.ArgumentPackage.eINSTANCE.getArgumentDiagram());

			elements.put(Argument_2001,
					argument.argument.ArgumentPackage.eINSTANCE.getArgument());

			elements.put(Argument_3001,
					argument.argument.ArgumentPackage.eINSTANCE.getArgument());

			elements.put(Argument_3002,
					argument.argument.ArgumentPackage.eINSTANCE.getArgument());

			elements.put(Rebuts_4001,
					argument.argument.ArgumentPackage.eINSTANCE.getRebuts());

			elements.put(Mitigates_4002,
					argument.argument.ArgumentPackage.eINSTANCE.getMitigates());

			elements.put(RebutsOrigin_4003,
					argument.argument.ArgumentPackage.eINSTANCE.getRebuts_Origin());

			elements.put(MitigatesRebuttal_4004,
					argument.argument.ArgumentPackage.eINSTANCE.getMitigates_Rebuttal());

			elements.put(ArgumentOrigin_4005,
					argument.argument.ArgumentPackage.eINSTANCE.getArgument_Origin());
		}
