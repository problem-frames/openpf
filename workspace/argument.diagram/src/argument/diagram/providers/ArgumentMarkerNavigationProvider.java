 ...
 * @generated
 */
public class ArgumentMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ArgumentDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ArgumentDiagramEditorUtil.selectElementsInDiagram(editor,
