...
public class ArgumentNavigatorLabelProvider extends LabelProvider implements
	...
	private String getArgumentDiagram_1000Text(View view) {
		argument.argument.ArgumentDiagram domainModelElement = (argument.argument.ArgumentDiagram) view
				.getElement();
	...
	private String getMitigates_4002Text(View view) {
		argument.argument.Mitigates domainModelElement = (argument.argument.Mitigates) view
				.getElement();
		if (domainModelElement != null) {
	...
	private String getRebuts_4001Text(View view) {
		argument.argument.Rebuts domainModelElement = (argument.argument.Rebuts) view
				.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isGenerated());
		} else {
