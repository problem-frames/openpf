...
public class ArgumentNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ArgumentOrigin2EditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ArgumentNavigatorGroup target = new ArgumentNavigatorGroup(
					Messages.NavigatorGroupName_ArgumentOrigin_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ArgumentNavigatorGroup source = new ArgumentNavigatorGroup(
					Messages.NavigatorGroupName_ArgumentOrigin_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ArgumentVisualIDRegistry
		...
		case ArgumentOriginEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ArgumentNavigatorGroup target = new ArgumentNavigatorGroup(
					Messages.NavigatorGroupName_MitigatesRebuttal_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ArgumentNavigatorGroup source = new ArgumentNavigatorGroup(
					Messages.NavigatorGroupName_MitigatesRebuttal_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ArgumentVisualIDRegistry
