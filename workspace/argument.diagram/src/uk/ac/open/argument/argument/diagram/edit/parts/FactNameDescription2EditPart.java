 ...
 * @generated
 */
public class FactNameDescription2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FactNameDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ArgumentParserProvider
					.getParser(
							...
							ArgumentVisualIDRegistry
									.getType(uk.ac.open.argument.argument.diagram.edit.parts.FactNameDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
