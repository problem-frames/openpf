 ...
 * @generated
 */
public class RestoresCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RestoresCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ArgumentBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRestores_4003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Restores newElement = ArgumentFactory.eINSTANCE.createRestores();
	 ...
	 * @generated
	 */
	protected void doConfigure(Restores newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
