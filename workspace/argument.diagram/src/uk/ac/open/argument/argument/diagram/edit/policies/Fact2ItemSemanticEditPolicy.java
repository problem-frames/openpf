 ...
 * @generated
 */
public class Fact2ItemSemanticEditPolicy extends
		ArgumentBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Fact2ItemSemanticEditPolicy() {
		super(ArgumentElementTypes.Fact_3001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ArgumentVisualIDRegistry.getVisualID(outgoingLink) == FactOriginEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
