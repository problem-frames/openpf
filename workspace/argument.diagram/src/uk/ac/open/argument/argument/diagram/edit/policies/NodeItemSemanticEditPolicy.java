...
import uk.ac.open.argument.argument.diagram.edit.commands.LinkCreateCommand;
import uk.ac.open.argument.argument.diagram.edit.commands.LinkReorientCommand;
...
public class NodeItemSemanticEditPolicy extends
	...
	public NodeItemSemanticEditPolicy() {
		super(ArgumentElementTypes.Node_2001);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (ArgumentElementTypes.Link_4001 == req.getElementType()) {
