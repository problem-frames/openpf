...
import uk.ac.open.argument.argument.diagram.edit.policies.Claim2ItemSemanticEditPolicy;
import uk.ac.open.argument.argument.diagram.part.ArgumentVisualIDRegistry;

/**
 * @generated
 */
public class Claim2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Claim2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Claim2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClaimName2EditPart) {
			((ClaimName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArgumentVisualIDRegistry
				.getType(ClaimName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class ClaimFigure extends RoundedRectangle {
