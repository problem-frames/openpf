...
import uk.ac.open.argument.argument.diagram.edit.policies.Claim3ItemSemanticEditPolicy;
import uk.ac.open.argument.argument.diagram.part.ArgumentVisualIDRegistry;

/**
 * @generated
 */
public class Claim3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Claim3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Claim3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClaimName3EditPart) {
			((ClaimName3EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArgumentVisualIDRegistry
				.getType(ClaimName3EditPart.VISUAL_ID));
	}
