 ...
 * @generated
 */
public class FactNameDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FactNameDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ArgumentParserProvider
					.getParser(
							...
							ArgumentVisualIDRegistry
									.getType(uk.ac.open.argument.argument.diagram.edit.parts.FactNameDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
