...
public class LinkReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof SplitCommas && newEnd instanceof SplitCommas)) {
			return false;
		}
		Node source = getLink().getAfrom();
		if (!(getLink().eContainer() instanceof ArgumentDiagram)) {
			return false;
		}
		ArgumentDiagram container = (ArgumentDiagram) getLink().eContainer();
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getLink().setToNode1(getNewTarget());
		return CommandResult.newOKCommandResult(getLink());
	}
	 ...
	 * @generated
	 */
	protected SplitCommas getOldTarget() {
		return (SplitCommas) oldEnd;
	}

	/**
	 * @generated
	 */
	protected SplitCommas getNewTarget() {
		return (SplitCommas) newEnd;
	}
}
