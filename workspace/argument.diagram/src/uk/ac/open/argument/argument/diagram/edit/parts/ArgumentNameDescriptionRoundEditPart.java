 ...
 * @generated
 */
public class ArgumentNameDescriptionRoundEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ArgumentNameDescriptionRoundEditPart(View view) {
		super(view);
	}
			...
			parser = ArgumentParserProvider
					.getParser(
							...
							ArgumentVisualIDRegistry
									.getType(uk.ac.open.argument.argument.diagram.edit.parts.ArgumentNameDescriptionRoundEditPart.VISUAL_ID));
		}
		return parser;
	}
