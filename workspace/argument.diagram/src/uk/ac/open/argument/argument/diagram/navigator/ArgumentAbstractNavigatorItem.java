		...
		Platform.getAdapterManager().registerAdapters(
				new IAdapterFactory() {
					...
					public Object getAdapter(Object adaptableObject,
							Class adapterType) {
						if (adaptableObject instanceof uk.ac.open.argument.argument.diagram.navigator.ArgumentAbstractNavigatorItem
				...
				uk.ac.open.argument.argument.diagram.navigator.ArgumentAbstractNavigatorItem.class);
	}
