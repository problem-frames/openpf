...
import uk.ac.open.argument.argument.diagram.edit.policies.ClaimItemSemanticEditPolicy;
...
public class ClaimEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClaimNameEditPart) {
			((ClaimNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ArgumentVisualIDRegistry
				.getType(ClaimNameEditPart.VISUAL_ID));
	}
