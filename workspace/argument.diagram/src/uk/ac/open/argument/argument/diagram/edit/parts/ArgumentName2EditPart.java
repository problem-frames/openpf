 ...
 * @generated
 */
public class ArgumentName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArgumentName2EditPart(View view) {
		super(view);
	}
			...
			parser = ArgumentParserProvider
					.getParser(
							...
							ArgumentVisualIDRegistry
									.getType(uk.ac.open.argument.argument.diagram.edit.parts.ArgumentName2EditPart.VISUAL_ID));
		}
		return parser;
	}
