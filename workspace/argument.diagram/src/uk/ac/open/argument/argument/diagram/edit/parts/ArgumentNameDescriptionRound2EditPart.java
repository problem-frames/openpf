 ...
 * @generated
 */
public class ArgumentNameDescriptionRound2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ArgumentNameDescriptionRound2EditPart(View view) {
		super(view);
	}
			...
			parser = ArgumentParserProvider
					.getParser(
							...
							ArgumentVisualIDRegistry
									.getType(uk.ac.open.argument.argument.diagram.edit.parts.ArgumentNameDescriptionRound2EditPart.VISUAL_ID));
		}
		return parser;
	}
