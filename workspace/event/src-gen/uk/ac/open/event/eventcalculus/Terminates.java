...
public interface Terminates extends TemporalPredicate
{
  ...
  /**
   * Sets the value of the '{@link uk.ac.open.event.eventcalculus.Terminates#getEvent <em>Event</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link uk.ac.open.event.eventcalculus.Terminates#getFluent <em>Fluent</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
