 ...
 *   <li>{@link uk.ac.open.event.eventcalculus.AssignPlus#getQ <em>Q</em>}</li>
 * </ul>
 *
...
public interface AssignPlus extends Expression
{
   ...
   * @see #setQ(Qualifier)
   * @see uk.ac.open.event.eventcalculus.EventcalculusPackage#getAssignPlus_Q()
   * @model containment="true"
   * @generated
   */
  Qualifier getQ();
  ...
  /**
   * Sets the value of the '{@link uk.ac.open.event.eventcalculus.AssignPlus#getQ <em>Q</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
