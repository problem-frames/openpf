...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return EventcalculusPackage.Literals.MODEL;
  }
  ...
  public EList<Import> getImports()
  {
    if (imports == null)
    {
      imports = new EObjectContainmentEList<Import>(Import.class, this, EventcalculusPackage.MODEL__IMPORTS);
    }
    return imports;
  }
  ...
  public EList<Declaration> getDeclarations()
  {
    ...
    {
      declarations = new EObjectContainmentEList<Declaration>(Declaration.class, this, EventcalculusPackage.MODEL__DECLARATIONS);
    }
    return declarations;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, EventcalculusPackage.MODEL__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EventcalculusPackage.MODEL__IMPORTS:
        return ((InternalEList<?>)getImports()).basicRemove(otherEnd, msgs);
      case EventcalculusPackage.MODEL__DECLARATIONS:
        return ((InternalEList<?>)getDeclarations()).basicRemove(otherEnd, msgs);
      case EventcalculusPackage.MODEL__STATEMENTS:
