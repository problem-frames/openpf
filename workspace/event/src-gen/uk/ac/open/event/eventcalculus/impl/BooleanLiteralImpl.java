...
public class BooleanLiteralImpl extends TerminalExpressionImpl implements BooleanLiteral
{
  ...
  {
    return EventcalculusPackage.Literals.BOOLEAN_LITERAL;
  }
  ...
  public void setValue(boolean newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EventcalculusPackage.BOOLEAN_LITERAL__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EventcalculusPackage.BOOLEAN_LITERAL__VALUE:
        return isValue();
    }
