...
public class IntLiteralImpl extends TerminalExpressionImpl implements IntLiteral
{
  ...
  {
    return EventcalculusPackage.Literals.INT_LITERAL;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EventcalculusPackage.INT_LITERAL__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EventcalculusPackage.INT_LITERAL__VALUE:
        return getValue();
    }
