...
import it.unitn.disi.sistar.editors.plan.viewers.DeltaEvent;
import it.unitn.disi.sistar.editors.plan.viewers.IDeltaListener;
...
public class PlanContentProvider implements ITreeContentProvider, IDeltaListener {
	...
	*/
	public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
		...
		if(oldInput != null) {
			removeListenerFrom((PlanContainer)oldInput);
		}
		if(newInput != null) {
			addListenerTo((PlanContainer)newInput);
		}
	}
	...
	protected void removeListenerFrom(PlanContainer root) {
	...
	protected void addListenerTo(PlanContainer box) {
	...
	public Object[] getChildren(Object parentElement) {
		if(parentElement instanceof PlanContainer) {
			PlanContainer root = (PlanContainer)parentElement;
