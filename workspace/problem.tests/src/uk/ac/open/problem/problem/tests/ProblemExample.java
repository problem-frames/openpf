...
public class ProblemExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.problem"));
				ProblemDiagram root = ProblemFactory.eINSTANCE.createProblemDiagram();
