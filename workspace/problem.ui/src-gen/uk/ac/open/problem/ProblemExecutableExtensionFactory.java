...
public class ProblemExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		uk.ac.open.problem.internal.ProblemActivator instance = uk.ac.open.problem.internal.ProblemActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = uk.ac.open.problem.internal.ProblemActivator.getInstance().getInjector("uk.ac.open.problem.Problem");
