...
public class AntlrParserWrapper implements IParser {
	...
	private final ParserRule parserRuleName;

	private final IParser originalParser;

	public AntlrParserWrapper(ParserRule parserRuleName, IParser originalParser, Injector xtextInjector) {
...
//				}
	...
	private boolean isValidParseResult(IParseResult parseResult, EObject semanticElement) {
		...
		return parseResult.getSyntaxErrors().iterator().hasNext() && rootASTElement != null && semanticElement != null
