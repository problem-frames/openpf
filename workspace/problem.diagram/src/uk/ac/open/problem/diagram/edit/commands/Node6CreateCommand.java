 ...
 * @generated
 */
public class Node6CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Node6CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_Node_2006(newElement);
