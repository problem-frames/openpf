 ...
 * @generated
 */
public class Node8CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Node8CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_Node_2009(newElement);
