 ...
 * @generated
 */
public abstract class ProblemAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ProblemDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ProblemAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
