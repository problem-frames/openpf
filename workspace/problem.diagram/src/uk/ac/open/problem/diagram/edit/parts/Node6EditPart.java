...
import uk.ac.open.problem.diagram.edit.policies.Node6ItemSemanticEditPolicy;
...
public class Node6EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof NodeDescription6EditPart) {
			((NodeDescription6EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof uk.ac.open.problem.diagram.edit.parts.Node6EditPart) {
			types.add(ProblemElementTypes.Link_4001);
		}
