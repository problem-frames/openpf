 ...
 * @generated
 */
public class ProblemInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ProblemNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ProblemDiagramEditPart.MODEL_ID));
		ProblemDiagramEditorUtil.runWizard(getShell(), wizard,
