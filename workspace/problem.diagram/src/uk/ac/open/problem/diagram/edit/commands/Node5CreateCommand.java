 ...
 * @generated
 */
public class Node5CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Node5CreateCommand(CreateElementRequest req) {
...
//		ElementInitializers.getInstance().init_Node_2005(newElement);
