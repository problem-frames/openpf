...
public class Node8EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NodeName7EditPart) {
			((NodeName7EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEntityName());
			return true;
		}
		if (childEditPart instanceof NodeDescription8EditPart) {
			((NodeDescription8EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProblemVisualIDRegistry
				.getType(NodeName7EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof uk.ac.open.problem.diagram.edit.parts.Node8EditPart) {
			types.add(ProblemElementTypes.Link_4001);
		}
		if (targetEditPart instanceof NodeEditPart) {
			types.add(ProblemElementTypes.Link_4002);
