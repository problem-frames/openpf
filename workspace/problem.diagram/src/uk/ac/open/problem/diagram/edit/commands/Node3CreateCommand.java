 ...
 * @generated
 */
public class Node3CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Node3CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_Node_2003(newElement);
