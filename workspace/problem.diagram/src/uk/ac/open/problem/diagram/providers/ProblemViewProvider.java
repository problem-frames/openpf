 ...
 * @generated
 */
public class ProblemViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ProblemDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				if (!ProblemElementTypes.isKnownElementType(elementType)
				...
				if (!ProblemDiagramEditPart.MODEL_ID
						.equals(ProblemVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return NodeEditPart.VISUAL_ID == visualID
				...
				|| Node8EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ProblemVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ProblemVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ProblemDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = ProblemVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = ProblemVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case NodeEditPart.VISUAL_ID:
		...
		case Node2EditPart.VISUAL_ID:
			return createNode_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node3EditPart.VISUAL_ID:
			return createNode_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node4EditPart.VISUAL_ID:
			return createNode_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node5EditPart.VISUAL_ID:
			return createNode_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node6EditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ProblemVisualIDRegistry.getVisualID(elementTypeHint)) {
		...
		case Link4EditPart.VISUAL_ID:
			return createLink_4004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createNode_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ProblemVisualIDRegistry.getType(Node3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNode_2008(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ProblemVisualIDRegistry.getType(Node8EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Edge createLink_4001(EObject domainElement, View containerView,
		...
		edge.setType(ProblemVisualIDRegistry.getType(LinkEditPart.VISUAL_ID));
	...
	public Edge createLink_4002(EObject domainElement, View containerView,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProblemVisualIDRegistry.getType(Link2EditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	public Edge createLink_4003(EObject domainElement, View containerView,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProblemVisualIDRegistry.getType(Link3EditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createLink_4004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProblemVisualIDRegistry.getType(Link4EditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6004 = createLabel(edge,
				ProblemVisualIDRegistry
						.getType(LinkDescription4EditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ProblemDiagramEditPart.MODEL_ID.equals(ProblemVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", ProblemDiagramEditPart.MODEL_ID); //$NON-NLS-1$
