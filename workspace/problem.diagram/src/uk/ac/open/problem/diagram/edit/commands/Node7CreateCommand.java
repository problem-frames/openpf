 ...
 * @generated
 */
public class Node7CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Node7CreateCommand(CreateElementRequest req) {
...
//		ElementInitializers.getInstance().init_Node_2007(newElement);
