...
public class ProblemDiagramEditor extends DiagramDocumentEditor implements
	 ...
	 * @generated
	 */
	public static final String ID = "uk.ac.open.problem.diagram.part.ProblemDiagramEditorID"; //$NON-NLS-1$
	...
	protected PaletteRoot createPaletteRoot(PaletteRoot existingPaletteRoot) {
		...
		new ProblemPaletteFactory().fillPalette(root);
		return root;
	}
	...
	public String getContributorId() {
		return ProblemDiagramEditorPlugin.ID;
	}
	...
	protected void setDocumentProvider(IEditorInput input) {
		if (input instanceof IFileEditorInput
				|| input instanceof URIEditorInput) {
			setDocumentProvider(ProblemDiagramEditorPlugin.getInstance()
					.getDocumentProvider());
		} else {
		...
		for (int i = 0; i < editorRefs.length; i++) {
			if (matchingStrategy.matches(editorRefs[i], newInput)) {
				MessageDialog.openWarning(shell,
						Messages.ProblemDiagramEditor_SaveAsErrorTitle,
						Messages.ProblemDiagramEditor_SaveAsErrorMessage);
				return;
			}
		}
