 ...
 * <ul>
 *   <li>{@link eu.securechange.situation.impl.DomainImpl#getName <em>Name</em>}</li>
...
public class DomainImpl extends ThingImpl implements Domain
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SituationPackage.DOMAIN__NAME, oldName, name));
  }
