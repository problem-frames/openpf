 ...
 * <ul>
 *   <li>{@link eu.securechange.situation.impl.BeliefWorldImpl#getDomains <em>Domains</em>}</li>
 *   <li>{@link eu.securechange.situation.impl.BeliefWorldImpl#getRelationships <em>Relationships</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BeliefWorldImpl extends MinimalEObjectImpl.Container implements BeliefWorld
{
  ...
  {
		return SituationPackage.Literals.BELIEF_WORLD;
	}
  ...
  {
		if (domains == null) {
			domains = new EObjectContainmentEList<Domain>(Domain.class, this, SituationPackage.BELIEF_WORLD__DOMAINS);
		}
		return domains;
	}
  ...
  public EList<Relationship> getRelationships()
  {
		if (relationships == null) {
			relationships = new EObjectContainmentEList<Relationship>(Relationship.class, this, SituationPackage.BELIEF_WORLD__RELATIONSHIPS);
		}
