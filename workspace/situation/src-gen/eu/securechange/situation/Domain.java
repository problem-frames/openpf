 ...
 * <ul>
 *   <li>{@link eu.securechange.situation.Domain#getName <em>Name</em>}</li>
...
public interface Domain extends Thing
{
   ...
   * @see #setName(String)
   * @see eu.securechange.situation.SituationPackage#getDomain_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link eu.securechange.situation.Domain#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
