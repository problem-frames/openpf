...
public class MakeImplCreateCommand implements Command {
	 ...
	 * @param model
	 */
	public MakeImplCreateCommand(ModelImpl m){
		model = m;
	}
	 ...
	 */
	public MakeImplCreateCommand(ContainerImpl c){
		container = c;
	}
	 ...
	 * @param model
	 */
	public MakeImplCreateCommand(ModelImpl m, IntentionImpl s, IntentionImpl t){
		model = m;
		source = s;
		target = t;
	}
	 ...
	 * @param model
	 */
	public MakeImplCreateCommand(IntentionImpl source, IntentionImpl target, ContainerImpl c){
		container = c;
	...
	public void execute() {
		MakeContributionImpl cont = (MakeContributionImpl) factory.createMakeContribution();
