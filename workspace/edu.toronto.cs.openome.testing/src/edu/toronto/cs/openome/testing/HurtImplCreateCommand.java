...
public class HurtImplCreateCommand implements Command {
	 ...
	 * @param model
	 */
	public HurtImplCreateCommand(ModelImpl m){
		model = m;
	}
	 ...
	 */
	public HurtImplCreateCommand(ContainerImpl c){
		container = c;
	}
	 ...
	 * @param model
	 */
	public HurtImplCreateCommand(ModelImpl m, IntentionImpl s, IntentionImpl t){
		model = m;
		source = s;
		target = t;
	}
	 ...
	 * @param model
	 */
	public HurtImplCreateCommand(IntentionImpl source, IntentionImpl target, ContainerImpl c){
		container = c;
