...
public class TestAddResourceGMF{
	...
	/*
	 * Our containers
	 * We should test adding a resource into all four types of containers
	 */
	...
	/**
	 * Tests that a new resource can be created outside of any actor
	 */
	@Test
	public void canAddResourceToModel() {
		String name = "testResource";
		
		assertTrue(model.getIntentions().isEmpty());
		
		Command create = new ResourceImplCreateCommand((ModelImpl) model, name);
		cs.execute(create);
		...
		assertTrue(model.getIntentions().get(0) instanceof ResourceImpl);
...
//		assertTrue(model.getIntentions().get(0).getModel().equals(model));
	...
	/**
	 * Tests that a new resource can be created inside of an actor
	 */
	@Test
	public void canAddResourceToActor() {
		String name = "testResource";
		
		assertTrue(actor.getIntentions().isEmpty());
		
		Command create = new ResourceImplCreateCommand(actor, name);
		cs.execute(create);
		...
		assertTrue(actor.getIntentions().get(0) instanceof ResourceImpl);
	...
	/**
	 * Tests that a new resource can be created inside of an agent
	 */
	@Test
	public void canAddResourceToAgent() {
		String name = "testResource";
		
		assertTrue(agent.getIntentions().isEmpty());
		
		Command create = new ResourceImplCreateCommand(agent, name);
		cs.execute(create);
		...
		assertTrue(agent.getIntentions().get(0) instanceof ResourceImpl);
	...
	/**
	 * Tests that a new resource can be created inside of a role
	 */
	@Test
	public void canAddResourceToRole() {
		String name = "testResource";
		
		assertTrue(role.getIntentions().isEmpty());
		
		Command create = new ResourceImplCreateCommand(role, name);
		cs.execute(create);
		...
		assertTrue(role.getIntentions().get(0) instanceof ResourceImpl);
	...
	/**
	 * Tests that a new resource can be created inside of a position
	 */
	@Test
	public void canAddResourceToPosition() {
		String name = "testResource";
		
		assertTrue(pos.getIntentions().isEmpty());
		
		Command create = new ResourceImplCreateCommand(pos, name);
		cs.execute(create);
		...
		assertTrue(pos.getIntentions().get(0) instanceof ResourceImpl);
