...
public class TestAddGoalGMF{
	...
	/**
	 * Tests that a new goal can be created outside of any actor
	 */
	@Test
	public void canAddGoalToModel() {
		...
		assertTrue(model.getIntentions().get(0) instanceof GoalImpl);
...
//		assertTrue(model.getIntentions().get(0).getModel().equals(model));
	...
	/**
	 * Tests that a new goal can be created inside of an actor
	 */
	@Test
	public void canAddGoalToActor() {
		String name = "testGoal";
		
		assertTrue(actor.getIntentions().isEmpty());
		
		Command create = new GoalImplCreateCommand(actor, name);
		cs.execute(create);
		...
		assertTrue(actor.getIntentions().get(0) instanceof GoalImpl);
	...
	/**
	 * Tests that a new goal can be created inside of an agent
	 */
	@Test
	public void canAddGoalToAgent() {
		String name = "testGoal";
		
		assertTrue(agent.getIntentions().isEmpty());
		
		Command create = new GoalImplCreateCommand(agent, name);
		cs.execute(create);
		...
		assertTrue(agent.getIntentions().get(0) instanceof GoalImpl);
	...
	/**
	 * Tests that a new goal can be created inside of a role
	 */
	@Test
	public void canAddGoalToRole() {
		String name = "testGoal";
		
		assertTrue(role.getIntentions().isEmpty());
		
		Command create = new GoalImplCreateCommand(role, name);
		cs.execute(create);
		...
		assertTrue(role.getIntentions().get(0) instanceof GoalImpl);
	...
	/**
	 * Tests that a new goal can be created inside of a position
	 */
	@Test
	public void canAddGoalToPosition() {
		String name = "testGoal";
		
		assertTrue(pos.getIntentions().isEmpty());
		
		Command create = new GoalImplCreateCommand(pos, name);
		cs.execute(create);
		...
		assertTrue(pos.getIntentions().get(0) instanceof GoalImpl);
