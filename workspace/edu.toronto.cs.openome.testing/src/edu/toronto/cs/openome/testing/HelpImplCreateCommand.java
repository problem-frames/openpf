...
public class HelpImplCreateCommand implements Command {
	 ...
	 * @param model
	 */
	public HelpImplCreateCommand(ModelImpl m){
		model = m;
	}
	 ...
	 */
	public HelpImplCreateCommand(ContainerImpl c){
		container = c;
	}
	 ...
	 * @param model
	 */
	public HelpImplCreateCommand(ModelImpl m, IntentionImpl s, IntentionImpl t){
		model = m;
		source = s;
		target = t;
	}
	...
	public void execute() {
		HelpContributionImpl cont = (HelpContributionImpl) factory.createHelpContribution();
