...
public class TestAddSoftgoalGMF{
	...
	/*
	 * Our containers
	 * We should test adding a softgoal into all four types of containers
	 */
	...
	/**
	 * Tests that a new softgoal can be created outside of any actor
	 */
	@Test
	public void canAddSoftgoalToModel() {
		String name = "testSoftgoal";
		
		assertTrue(model.getIntentions().isEmpty());
		
		Command create = new SoftgoalImplCreateCommand((ModelImpl) model, name);
		cs.execute(create);
		...
		assertTrue(model.getIntentions().get(0) instanceof SoftgoalImpl);
...
//		assertTrue(model.getIntentions().get(0).getModel().equals(model));
	...
	/**
	 * Tests that a new softgoal can be created inside of an actor
	 */
	@Test
	public void canAddSoftgoalToActor() {
		String name = "testSoftgoal";
		
		assertTrue(actor.getIntentions().isEmpty());
		
		Command create = new SoftgoalImplCreateCommand(actor, name);
		cs.execute(create);
		...
		assertTrue(actor.getIntentions().get(0) instanceof SoftgoalImpl);
	...
	/**
	 * Tests that a new softgoal can be created inside of an agent
	 */
	@Test
	public void canAddSoftgoalToAgent() {
		String name = "testSoftgoal";
		
		assertTrue(agent.getIntentions().isEmpty());
		
		Command create = new SoftgoalImplCreateCommand(agent, name);
		cs.execute(create);
		...
		assertTrue(agent.getIntentions().get(0) instanceof SoftgoalImpl);
	...
	/**
	 * Tests that a new softgoal can be created inside of a role
	 */
	@Test
	public void canAddSoftgoalToRole() {
		String name = "testSoftgoal";
		
		assertTrue(role.getIntentions().isEmpty());
		
		Command create = new SoftgoalImplCreateCommand(role, name);
		cs.execute(create);
		...
		assertTrue(role.getIntentions().get(0) instanceof SoftgoalImpl);
	...
	/**
	 * Tests that a new softgoal can be created inside of a position
	 */
	@Test
	public void canAddSoftgoalToPosition() {
		String name = "testSoftgoal";
		
		assertTrue(pos.getIntentions().isEmpty());
		
		Command create = new SoftgoalImplCreateCommand(pos, name);
		cs.execute(create);
		...
		assertTrue(pos.getIntentions().get(0) instanceof SoftgoalImpl);
