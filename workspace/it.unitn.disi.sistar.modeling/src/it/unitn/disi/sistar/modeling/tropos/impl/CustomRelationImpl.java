 ...
 * </copyright>
 *
 * $Id: CustomRelationImpl.java,v 1.3 2007/07/24 09:08:24 swferry Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Custom Relation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.unitn.disi.sistar.modeling.tropos.impl.CustomRelationImpl#getPredicate <em>Predicate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CustomRelationImpl extends RelationImpl implements CustomRelation {
	/**
	...
	protected EClass eStaticClass() {
		return TroposPackage.Literals.CUSTOM_RELATION;
	}
	...
	public void setPredicate(String newPredicate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TroposPackage.CUSTOM_RELATION__PREDICATE, oldPredicate, predicate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TroposPackage.CUSTOM_RELATION__PREDICATE:
				return getPredicate();
		}
