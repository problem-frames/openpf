...
public class A5ClassValidationAction implements IObjectActionDelegate, SistarConstants{
	...
	public A5ClassValidationAction(){
		super();
	}
	...
	public void run(IAction action){
        ...
        Schema schema = factory.newSchema(classSchema);
        ...
        // 5. Check the document
            ...
            MessageDialog.openInformation(null, "Validation complete", "The class file " +
            		"\"" + filename + "\" is valid.");
        }
            ...
            String filename = selectedFile.getName();
            MessageDialog.openError( null, "Validation Error", "The class file \" " 
