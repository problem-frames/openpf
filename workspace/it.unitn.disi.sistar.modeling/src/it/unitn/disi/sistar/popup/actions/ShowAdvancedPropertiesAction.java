...
public class ShowAdvancedPropertiesAction implements IObjectActionDelegate{
	...
	public void run(IAction action) {
		InputDialog dialog = new InputDialog(part.getSite().getShell(),"Advanced Properties", selectedItem.getName(), 
				selectedItem.getServiceProperties(), null)
		{
			@Override
			protected Control createDialogArea(Composite parent) {
				...
				List choiceList = (List) PropertyConfig.getInstance().getServiceProperties().get("SERVICE");
				...
				addButton.addSelectionListener(new SelectionListener()
				{
					...
					public void widgetSelected(SelectionEvent e) {
						...
						final Map propertyMap = CollectionUtil.stringToMap(selectedItem.getServiceProperties());
						...
						domain.getCommandStack().execute(new RecordingCommand(domain) {
							protected void doExecute() {
								selectedItem.setServiceProperties(CollectionUtil.mapToString(propertyMap));
							}
						});
						
						getText().setText(selectedItem.getServiceProperties());
					}
				});
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if(selectedObject!= null && selectedObject instanceof IServiceEditPart)
		{
			selectedItem = ((IServiceEditPart)selectedObject).getElement();
