 ...
 * @generated
 */
public class IsAAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IsAAssociationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.IsAAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistIsAAssociation_3013(container,
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.IsAAssociation getLink() {
		return (edu.toronto.cs.openome_model.IsAAssociation) getElementToEdit();
	}
