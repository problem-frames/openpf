 ...
 * @generated
 */
public abstract class Openome_modelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = edu.toronto.cs.openome_model.diagram.part.Openome_modelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected Openome_modelAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
