 ...
 * @generated
 */
public class Goal5EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public Goal5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.Goal5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.GoalName5EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.GoalName5EditPart) childEditPart)
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.GoalQualitativeReasoningCom5EditPart) {
