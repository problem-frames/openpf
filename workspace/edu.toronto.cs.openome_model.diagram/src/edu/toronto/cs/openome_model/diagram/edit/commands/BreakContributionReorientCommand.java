 ...
 * @generated
 */
public class BreakContributionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BreakContributionReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistBreakContribution_3007(container,
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.BreakContribution getLink() {
		return (edu.toronto.cs.openome_model.BreakContribution) getElementToEdit();
	}
