 ...
 * @generated
 */
public class AndContributionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AndContributionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.AndContribution) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAndContribution_3011(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		edu.toronto.cs.openome_model.Model container = (edu.toronto.cs.openome_model.Model) getLink()
				.eContainer();
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAndContribution_3011(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.AndContribution getLink() {
		return (edu.toronto.cs.openome_model.AndContribution) getElementToEdit();
	}
