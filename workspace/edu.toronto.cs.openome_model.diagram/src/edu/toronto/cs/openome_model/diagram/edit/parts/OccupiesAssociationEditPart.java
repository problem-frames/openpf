 ...
 * @generated
 */
public class OccupiesAssociationEditPart extends CustomConnectionNodeEditPart
	 ...
	 * @generated
	 */
	public OccupiesAssociationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.OccupiesAssociationItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.OccupiesAssociationLabelEditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.OccupiesAssociationLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureOccupiesAssociation());
			return true;
		}
		return false;
	}
	...
	protected Connection createConnectionFigure() {
		return new OccupiesAssociationFigure();
	}

	/**
	 * @generated
	 */
	public OccupiesAssociationFigure getPrimaryShape() {
		return (OccupiesAssociationFigure) getFigure();
	}
	 ...
	 * @generated
	 */
	public class OccupiesAssociationFigure extends PolylineConnectionEx {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureOccupiesAssociation;
		...
		private void createContents() {
			...
			fFigureOccupiesAssociation = new WrappingLabel();
			fFigureOccupiesAssociation.setText("Occupies");

			this.add(fFigureOccupiesAssociation);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureOccupiesAssociation() {
			return fFigureOccupiesAssociation;
		}
