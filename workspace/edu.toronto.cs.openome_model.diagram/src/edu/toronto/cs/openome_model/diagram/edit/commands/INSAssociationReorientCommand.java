 ...
 * @generated
 */
public class INSAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public INSAssociationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.INSAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistINSAssociation_3018(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		edu.toronto.cs.openome_model.Model container = (edu.toronto.cs.openome_model.Model) getLink()
				.eContainer();
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistINSAssociation_3018(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.INSAssociation getLink() {
		return (edu.toronto.cs.openome_model.INSAssociation) getElementToEdit();
	}
