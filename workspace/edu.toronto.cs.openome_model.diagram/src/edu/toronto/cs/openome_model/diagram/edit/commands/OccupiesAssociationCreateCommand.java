 ...
 * @generated
 */
public class OccupiesAssociationCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OccupiesAssociationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null
				&& false == source instanceof edu.toronto.cs.openome_model.Container) {
			return false;
		}
		if (target != null
				&& false == target instanceof edu.toronto.cs.openome_model.Container) {
			return false;
		}
		if (getSource() == null) {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateOccupiesAssociation_3015(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		edu.toronto.cs.openome_model.OccupiesAssociation newElement = edu.toronto.cs.openome_model.openome_modelFactory.eINSTANCE
				.createOccupiesAssociation();
	...
	protected void doConfigure(
			edu.toronto.cs.openome_model.OccupiesAssociation newElement,
