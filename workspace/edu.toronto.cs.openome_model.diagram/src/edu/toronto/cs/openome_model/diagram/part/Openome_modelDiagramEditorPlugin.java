 ...
 * @generated
 */
public class Openome_modelDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "edu.toronto.cs.openome_model.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static Openome_modelDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private edu.toronto.cs.openome_model.diagram.part.Openome_modelDocumentProvider documentProvider;
	 ...
	 * @generated
	 */
	public static Openome_modelDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public edu.toronto.cs.openome_model.diagram.part.Openome_modelDocumentProvider getDocumentProvider() {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, Openome_modelDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, Openome_modelDiagramEditorPlugin.ID,
