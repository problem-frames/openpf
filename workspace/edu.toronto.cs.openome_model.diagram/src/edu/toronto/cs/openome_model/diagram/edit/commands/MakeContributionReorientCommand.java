 ...
 * @generated
 */
public class MakeContributionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MakeContributionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.MakeContribution) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMakeContribution_3006(container,
