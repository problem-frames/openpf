 ...
 * @generated
 */
public class HurtContributionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HurtContributionReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistHurtContribution_3005(container,
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.HurtContribution getLink() {
		return (edu.toronto.cs.openome_model.HurtContribution) getElementToEdit();
	}
