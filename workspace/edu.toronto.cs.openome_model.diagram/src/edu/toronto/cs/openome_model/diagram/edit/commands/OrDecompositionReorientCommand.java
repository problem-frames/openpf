 ...
 * @generated
 */
public class OrDecompositionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OrDecompositionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.OrDecomposition) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistOrDecomposition_3003(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		edu.toronto.cs.openome_model.Model container = (edu.toronto.cs.openome_model.Model) getLink()
				.eContainer();
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistOrDecomposition_3003(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.OrDecomposition getLink() {
		return (edu.toronto.cs.openome_model.OrDecomposition) getElementToEdit();
	}
