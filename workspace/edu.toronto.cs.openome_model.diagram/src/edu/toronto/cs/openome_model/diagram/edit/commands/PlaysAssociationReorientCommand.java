 ...
 * @generated
 */
public class PlaysAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PlaysAssociationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.PlaysAssociation) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.PlaysAssociation getLink() {
		return (edu.toronto.cs.openome_model.PlaysAssociation) getElementToEdit();
	}
