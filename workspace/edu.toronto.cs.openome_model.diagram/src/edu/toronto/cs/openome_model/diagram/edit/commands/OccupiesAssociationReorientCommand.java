 ...
 * @generated
 */
public class OccupiesAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OccupiesAssociationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.OccupiesAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistOccupiesAssociation_3015(
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.OccupiesAssociation getLink() {
		return (edu.toronto.cs.openome_model.OccupiesAssociation) getElementToEdit();
	}
