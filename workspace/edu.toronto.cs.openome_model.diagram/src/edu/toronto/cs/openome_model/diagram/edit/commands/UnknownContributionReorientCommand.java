 ...
 * @generated
 */
public class UnknownContributionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public UnknownContributionReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.UnknownContribution) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistUnknownContribution_3010(
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.UnknownContribution getLink() {
		return (edu.toronto.cs.openome_model.UnknownContribution) getElementToEdit();
	}
