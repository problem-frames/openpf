 ...
 * @generated
 */
public class SomePlusContributionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SomePlusContributionReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof edu.toronto.cs.openome_model.SomePlusContribution) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return edu.toronto.cs.openome_model.diagram.edit.policies.Openome_modelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistSomePlusContribution_3008(
	 ...
	 * @generated
	 */
	protected edu.toronto.cs.openome_model.SomePlusContribution getLink() {
		return (edu.toronto.cs.openome_model.SomePlusContribution) getElementToEdit();
	}
