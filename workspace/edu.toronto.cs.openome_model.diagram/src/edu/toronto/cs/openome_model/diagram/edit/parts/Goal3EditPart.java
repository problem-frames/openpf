 ...
 * @generated
 */
public class Goal3EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public Goal3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.Goal3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.GoalName3EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.GoalName3EditPart) childEditPart)
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.GoalQualitativeReasoningCom3EditPart) {
