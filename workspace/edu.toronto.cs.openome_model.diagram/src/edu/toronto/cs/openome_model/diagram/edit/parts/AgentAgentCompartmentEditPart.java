 ...
 * @generated
 */
public class AgentAgentCompartmentEditPart extends CompartmentEditPart {
	...
	/**
	 * The stored width of the agent figure.
	 * This is used for restoring (expanding) the agent
	...
	public String getCompartmentName() {
		return edu.toronto.cs.openome_model.diagram.part.Messages.AgentAgentCompartmentEditPart_title;
	}
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (NotationPackage.eINSTANCE.getSize_Width().equals(feature)
			...
			IGraphicalEditPart agentEdit = (IGraphicalEditPart) getParent();
			((AgentEditPart) agentEdit).getPrimaryShape().setMinimumContraction(minimumContraction);
			...
			if(((Boolean) getStructuralFeatureValue(NotationPackage.eINSTANCE
					.getDrawerStyle_Collapsed())).booleanValue() || 
					children.size() == 0){
				((AgentEditPart) agentEdit).getPrimaryShape().setMinimumContraction(
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.AgentAgentCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.AgentAgentCompartmentCanonicalEditPolicy());
	}
