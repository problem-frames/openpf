 ...
 * @generated
 */
public class Goal4EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public Goal4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.Goal4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.GoalName4EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.GoalName4EditPart) childEditPart)
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.GoalQualitativeReasoningCom4EditPart) {
