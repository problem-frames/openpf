...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private edu.toronto.cs.openome_model.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new edu.toronto.cs.openome_model.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
