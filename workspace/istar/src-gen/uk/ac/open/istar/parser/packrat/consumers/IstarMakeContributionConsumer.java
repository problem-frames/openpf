...
import uk.ac.open.istar.services.IstarGrammarAccess.MakeContributionElements;

public final class IstarMakeContributionConsumer extends NonTerminalConsumer {

	private MakeContributionElements rule;	
	...
	public IstarMakeContributionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public MakeContributionElements getRule() {
		return rule;
	}
	
	public void setRule(MakeContributionElements rule) {
		this.rule = rule;
		...
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getHyphenMinusLeftParenthesisPlusSignPlusSignRightParenthesisHyphenMinusGreaterThanSignKeyword_1());
