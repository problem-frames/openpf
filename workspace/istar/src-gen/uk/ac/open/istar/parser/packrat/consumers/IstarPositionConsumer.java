...
import uk.ac.open.istar.services.IstarGrammarAccess.PositionElements;

public final class IstarPositionConsumer extends NonTerminalConsumer {

	private PositionElements rule;	
	...
	public IstarPositionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public PositionElements getRule() {
		return rule;
	}
	
	public void setRule(PositionElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getPositionKeyword_0());
