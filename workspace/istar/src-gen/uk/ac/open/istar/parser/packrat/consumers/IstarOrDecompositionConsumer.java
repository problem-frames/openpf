...
import uk.ac.open.istar.services.IstarGrammarAccess.OrDecompositionElements;

public final class IstarOrDecompositionConsumer extends NonTerminalConsumer {

	private OrDecompositionElements rule;	
	...
	public IstarOrDecompositionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public OrDecompositionElements getRule() {
		return rule;
	}
	
	public void setRule(OrDecompositionElements rule) {
		this.rule = rule;
		...
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getOrKeyword_1());
