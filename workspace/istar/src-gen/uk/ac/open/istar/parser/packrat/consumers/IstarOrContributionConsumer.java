...
import uk.ac.open.istar.services.IstarGrammarAccess.OrContributionElements;

public final class IstarOrContributionConsumer extends NonTerminalConsumer {

	private OrContributionElements rule;	
	...
	public IstarOrContributionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public OrContributionElements getRule() {
		return rule;
	}
	
	public void setRule(OrContributionElements rule) {
		this.rule = rule;
