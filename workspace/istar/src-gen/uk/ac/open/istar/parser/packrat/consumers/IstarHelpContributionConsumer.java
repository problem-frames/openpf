...
import uk.ac.open.istar.services.IstarGrammarAccess.HelpContributionElements;

public final class IstarHelpContributionConsumer extends NonTerminalConsumer {

	private HelpContributionElements rule;	
	...
	public IstarHelpContributionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public HelpContributionElements getRule() {
		return rule;
	}
	
	public void setRule(HelpContributionElements rule) {
		this.rule = rule;
		...
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getHyphenMinusLeftParenthesisPlusSignRightParenthesisHyphenMinusGreaterThanSignKeyword_1());
