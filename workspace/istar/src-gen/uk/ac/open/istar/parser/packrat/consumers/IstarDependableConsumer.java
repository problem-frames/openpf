...
import uk.ac.open.istar.services.IstarGrammarAccess.DependableElements;

public final class IstarDependableConsumer extends NonTerminalConsumer {

	private DependableElements rule;	
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(intentionConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(containerConsumer, null, false, false, false, getElement(), optional);
		}
	}

	public IstarDependableConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public DependableElements getRule() {
		return rule;
	}
	
	public void setRule(DependableElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getIntentionParserRuleCall_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getContainerParserRuleCall_1());
	}
