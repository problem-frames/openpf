...
import uk.ac.open.istar.services.IstarGrammarAccess.AndContributionElements;

public final class IstarAndContributionConsumer extends NonTerminalConsumer {

	private AndContributionElements rule;	
	...
	public IstarAndContributionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AndContributionElements getRule() {
		return rule;
	}
	
	public void setRule(AndContributionElements rule) {
		this.rule = rule;
