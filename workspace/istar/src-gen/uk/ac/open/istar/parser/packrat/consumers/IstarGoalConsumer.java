...
import uk.ac.open.istar.services.IstarGrammarAccess.GoalElements;

public final class IstarGoalConsumer extends NonTerminalConsumer {

	private GoalElements rule;	
	...
	protected class CrossReference$8$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "decompositions", true, false, getElement(), getRuleCall$10$Delimiter(), optional);
		}
	}
	...
	public IstarGoalConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public GoalElements getRule() {
		return rule;
	}
	
	public void setRule(GoalElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getGoalKeyword_0());
		...
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getDecompositionsAssignment_2_1());
		crossReference$8$Consumer = new CrossReference$8$Consumer(rule.getDecompositionsDecompositionCrossReference_2_1_0());
		keyword$11$Consumer = new Keyword$11$Consumer(rule.getRightCurlyBracketKeyword_2_2());
	}
