...
import uk.ac.open.istar.services.IstarGrammarAccess.AssociationElements;

public final class IstarAssociationConsumer extends NonTerminalConsumer {

	private AssociationElements rule;	
	...
	public IstarAssociationConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AssociationElements getRule() {
		return rule;
	}
	
	public void setRule(AssociationElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		assignment$2$Consumer = new Assignment$2$Consumer(rule.getSourceAssignment_0());
		crossReference$3$Consumer = new CrossReference$3$Consumer(rule.getSourceContainerCrossReference_0_0());
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getTildeTildeGreaterThanSignKeyword_1());
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getTargetAssignment_2());
		crossReference$8$Consumer = new CrossReference$8$Consumer(rule.getTargetContainerCrossReference_2_0());
	}
