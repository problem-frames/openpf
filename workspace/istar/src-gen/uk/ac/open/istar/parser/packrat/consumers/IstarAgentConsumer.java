...
import uk.ac.open.istar.services.IstarGrammarAccess.AgentElements;

public final class IstarAgentConsumer extends NonTerminalConsumer {

	private AgentElements rule;	
	...
	public IstarAgentConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AgentElements getRule() {
		return rule;
	}
	
	public void setRule(AgentElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getAgentKeyword_0());
