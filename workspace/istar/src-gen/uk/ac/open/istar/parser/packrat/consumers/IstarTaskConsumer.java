...
import uk.ac.open.istar.services.IstarGrammarAccess.TaskElements;

public final class IstarTaskConsumer extends NonTerminalConsumer {

	private TaskElements rule;	
	...
	public IstarTaskConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TaskElements getRule() {
		return rule;
	}
	
	public void setRule(TaskElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getTaskKeyword_0());
