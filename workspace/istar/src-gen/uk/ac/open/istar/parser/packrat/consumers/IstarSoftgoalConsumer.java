...
import uk.ac.open.istar.services.IstarGrammarAccess.SoftgoalElements;

public final class IstarSoftgoalConsumer extends NonTerminalConsumer {

	private SoftgoalElements rule;	
	...
	public IstarSoftgoalConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SoftgoalElements getRule() {
		return rule;
	}
	
	public void setRule(SoftgoalElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getSoftKeyword_0());
