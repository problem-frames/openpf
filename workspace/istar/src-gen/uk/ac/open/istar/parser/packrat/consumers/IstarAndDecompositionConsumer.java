...
import uk.ac.open.istar.services.IstarGrammarAccess.AndDecompositionElements;

public final class IstarAndDecompositionConsumer extends NonTerminalConsumer {

	private AndDecompositionElements rule;	
	...
	protected class CrossReference$3$Consumer extends ElementConsumer<CrossReference> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "target", false, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}
	...
	protected class CrossReference$8$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "source", false, false, getElement(), getRuleCall$10$Delimiter(), optional);
		}
	}

	public IstarAndDecompositionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AndDecompositionElements getRule() {
		return rule;
	}
	
	public void setRule(AndDecompositionElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		assignment$2$Consumer = new Assignment$2$Consumer(rule.getTargetAssignment_0());
		crossReference$3$Consumer = new CrossReference$3$Consumer(rule.getTargetIntentionCrossReference_0_0());
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getAndKeyword_1());
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getSourceAssignment_2());
		crossReference$8$Consumer = new CrossReference$8$Consumer(rule.getSourceIntentionCrossReference_2_0());
	}
