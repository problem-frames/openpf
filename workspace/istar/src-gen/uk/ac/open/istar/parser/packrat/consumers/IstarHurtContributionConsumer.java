...
import uk.ac.open.istar.services.IstarGrammarAccess.HurtContributionElements;

public final class IstarHurtContributionConsumer extends NonTerminalConsumer {

	private HurtContributionElements rule;	
	...
	public IstarHurtContributionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public HurtContributionElements getRule() {
		return rule;
	}
	
	public void setRule(HurtContributionElements rule) {
		this.rule = rule;
		...
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getHyphenMinusLeftParenthesisHyphenMinusRightParenthesisHyphenMinusGreaterThanSignKeyword_1());
