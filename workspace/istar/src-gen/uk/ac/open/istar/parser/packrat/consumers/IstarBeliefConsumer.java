...
import uk.ac.open.istar.services.IstarGrammarAccess.BeliefElements;

public final class IstarBeliefConsumer extends NonTerminalConsumer {

	private BeliefElements rule;	
	...
	public IstarBeliefConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public BeliefElements getRule() {
		return rule;
	}
	
	public void setRule(BeliefElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getBeliefKeyword_0());
