...
import uk.ac.open.istar.services.IstarGrammarAccess.ResourceElements;

public final class IstarResourceConsumer extends NonTerminalConsumer {

	private ResourceElements rule;	
	...
	public IstarResourceConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ResourceElements getRule() {
		return rule;
	}
	
	public void setRule(ResourceElements rule) {
		this.rule = rule;
