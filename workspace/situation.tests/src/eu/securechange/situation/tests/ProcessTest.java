 ...
 * @generated
 */
public class ProcessTest extends EntityTest {
	 ...
	 */
	@Override
	protected eu.securechange.situation.Process getFixture() {
		return (eu.securechange.situation.Process)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(SituationFactory.eINSTANCE.createProcess());
	}
