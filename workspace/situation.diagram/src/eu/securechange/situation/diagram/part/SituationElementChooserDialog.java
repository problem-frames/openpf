 ...
 * @generated
 */
public class SituationElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public SituationElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.SituationElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "situation".equals(fileExtension); //$NON-NLS-1$
	}
