 ...
 * @generated
 */
public class SituationInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SituationNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SituationEditPart.MODEL_ID));
		SituationDiagramEditorUtil.runWizard(getShell(), wizard,
