 ...
 * @generated
 */
public class DomainEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DomainFigure();
	}

	/**
	 * @generated
	 */
	public DomainFigure getPrimaryShape() {
		return (DomainFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DomainTypeEditPart) {
			((DomainTypeEditPart) childEditPart).setLabel(getPrimaryShape()
	 ...
	 * @generated
	 */
	public class DomainFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDomainLabelFigure;
