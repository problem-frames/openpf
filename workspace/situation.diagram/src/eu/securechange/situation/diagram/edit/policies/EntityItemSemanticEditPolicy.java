...
public class EntityItemSemanticEditPolicy extends
	...
	public EntityItemSemanticEditPolicy() {
		super(SituationElementTypes.Entity_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (SituationVisualIDRegistry.getVisualID(incomingLink) == RelationshipEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (SituationVisualIDRegistry.getVisualID(outgoingLink) == RelationshipEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
