...
public class RelationshipCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final Situation container;
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Thing) {
			return false;
		}
		...
		return SituationBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRelationship_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Relationship newElement = SituationFactory.eINSTANCE
				.createRelationship();
		getContainer().getThings().add(newElement);
	 ...
	 * @generated
	 */
	private static Situation deduceContainer(EObject source, EObject target) {
