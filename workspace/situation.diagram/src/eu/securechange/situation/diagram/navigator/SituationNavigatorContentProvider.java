 ...
 * @generated
 */
public class SituationNavigatorContentProvider implements
	...
	public SituationNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<SituationNavigatorItem> result = new ArrayList<SituationNavigatorItem>();
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, SituationEditPart.MODEL_ID),
					file, false));
			return result.toArray();
		}

		if (parentElement instanceof SituationNavigatorGroup) {
			SituationNavigatorGroup group = (SituationNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof SituationNavigatorItem) {
			SituationNavigatorItem navigatorItem = (SituationNavigatorItem) parentElement;
	 ...
	 * @generated
	 */
	private Collection<SituationNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<SituationNavigatorItem> result = new ArrayList<SituationNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new SituationNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<SituationNavigatorItem> getForeignShortcuts(
	...
	public Object getParent(Object element) {
		if (element instanceof SituationAbstractNavigatorItem) {
			SituationAbstractNavigatorItem abstractNavigatorItem = (SituationAbstractNavigatorItem) element;
