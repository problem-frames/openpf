 ...
 * @generated
 */
public class SituationParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	private IParser getEntityName_5001Parser() {
		if (entityName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { SituationPackage.eINSTANCE
					.getEntity_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			entityName_5001Parser = parser;
		}
		return entityName_5001Parser;
	}

	/**
	 * @generated
	 */
	private IParser domainType_5002Parser;

	/**
	 * @generated
	 */
	private IParser getDomainType_5002Parser() {
		if (domainType_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { SituationPackage.eINSTANCE
					.getDomain_Type() };
			MessageFormatParser parser = new MessageFormatParser(features);
			domainType_5002Parser = parser;
		}
		return domainType_5002Parser;
	}
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(SituationVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(SituationVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (SituationElementTypes.getElement(hint) == null) {
				return false;
			}
