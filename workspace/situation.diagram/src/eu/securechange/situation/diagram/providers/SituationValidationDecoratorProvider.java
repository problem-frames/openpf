...
import eu.securechange.situation.diagram.part.SituationDiagramEditor;
 ...
 * @generated
 */
public class SituationValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = SituationDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof SituationDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& SituationEditPart.MODEL_ID.equals(SituationVisualIDRegistry
						.getModelID(view));
	}
