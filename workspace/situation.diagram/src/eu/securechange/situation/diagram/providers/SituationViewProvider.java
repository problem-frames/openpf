 ...
 * @generated
 */
public class SituationViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SituationEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SituationVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = SituationVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!SituationElementTypes.isKnownElementType(elementType)
				...
				if (!SituationEditPart.MODEL_ID
						.equals(SituationVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = SituationVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != SituationVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(SituationEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = SituationVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = SituationVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EntityEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SituationVisualIDRegistry.getVisualID(elementTypeHint)) {
		case RelationshipEditPart.VISUAL_ID:
			return createRelationship_4001(getSemanticElement(semanticAdapter),
	...
	public Node createEntity_2001(EObject domainElement, View containerView,
		...
		Node label5001 = createLabel(node,
				SituationVisualIDRegistry.getType(EntityNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createRelationship_4001(EObject domainElement,
		...
		edge.setType(SituationVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SituationEditPart.MODEL_ID.equals(SituationVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", SituationEditPart.MODEL_ID); //$NON-NLS-1$
