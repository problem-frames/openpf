...
/**
 * This is the item provider adapter for a {@link eu.securechange.situation.Depends} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependsItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Depends_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Depends_kind_feature", "_UI_Depends_type"),
				 SituationPackage.Literals.DEPENDS__KIND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Depends)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Depends_type") :
			getString("_UI_Depends_type") + " " + label;
	}
