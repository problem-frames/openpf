...
import uk.ac.open.rbac.rbac.diagram.edit.helpers.RBACBaseEditHelper;
 ...
 * @generated
 */
public class RBACBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected RBACBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						RBACVisualIDRegistry.getVisualID((View) view));
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(RBACBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(RBACBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(RBACBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(RBACBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = RBACElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = RBACDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			RBACDiagramEditorPlugin.getInstance().setLinkConstraints(
