 ...
 * @generated
 */
public class RoleItemSemanticEditPolicy extends RBACBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RoleItemSemanticEditPolicy() {
		super(RBACElementTypes.Role_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RBACVisualIDRegistry.getVisualID(incomingLink) == UserRoleAssignmentEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (RBACVisualIDRegistry.getVisualID(outgoingLink) == RolePermissionAssignmentEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (RBACElementTypes.UserRoleAssignment_4001 == req.getElementType()) {
			return null;
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
			CreateRelationshipRequest req) {
		if (RBACElementTypes.UserRoleAssignment_4001 == req.getElementType()) {
			return getGEFWrapper(new UserRoleAssignmentCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (RBACElementTypes.RolePermissionAssignment_4002 == req
				.getElementType()) {
	...
	protected Command getReorientRelationshipCommand(
		...
		case UserRoleAssignmentEditPart.VISUAL_ID:
			return getGEFWrapper(new UserRoleAssignmentReorientCommand(req));
