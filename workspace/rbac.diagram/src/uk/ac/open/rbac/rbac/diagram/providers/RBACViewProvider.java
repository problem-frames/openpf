 ...
 * @generated
 */
public class RBACViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = RBACVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = RBACVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!RBACElementTypes.isKnownElementType(elementType)
				...
				if (!ModelEditPart.MODEL_ID.equals(RBACVisualIDRegistry
		...
		return RoleEditPart.VISUAL_ID == visualID
				|| UserEditPart.VISUAL_ID == visualID
				|| SessionEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = RBACVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != RBACVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = RBACVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = RBACVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case RoleEditPart.VISUAL_ID:
		...
		case UserEditPart.VISUAL_ID:
			return createUser_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case SessionEditPart.VISUAL_ID:
			return createSession_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ObjectEditPart.VISUAL_ID:
			return createObject_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (RBACVisualIDRegistry.getVisualID(elementTypeHint)) {
		case UserRoleAssignmentEditPart.VISUAL_ID:
			return createUserRoleAssignment_4001(
	...
	public Node createRole_2001(EObject domainElement, View containerView,
		...
		node.setType(RBACVisualIDRegistry.getType(RoleEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createUser_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RBACVisualIDRegistry.getType(UserEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createSession_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RBACVisualIDRegistry.getType(SessionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createObject_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RBACVisualIDRegistry.getType(ObjectEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Edge createUserRoleAssignment_4001(EObject domainElement,
	 ...
	 * @generated
	 */
	public Edge createRolePermissionAssignment_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	...
	public Edge createRolePermissions_4004(View containerView, int index,
		...
		Node label6002 = createLabel(edge,
				RBACVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
