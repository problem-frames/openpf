 ...
 * @generated
 */
public class UserItemSemanticEditPolicy extends RBACBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public UserItemSemanticEditPolicy() {
		super(RBACElementTypes.User_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (RBACVisualIDRegistry.getVisualID(outgoingLink) == UserRoleAssignmentEditPart.VISUAL_ID) {
