 ...
 * @generated
 */
public class SessionAssignmentsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SessionAssignmentsReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return RBACBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistSessionAssignments_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return RBACBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistSessionAssignments_4005(getOldSource(), getNewTarget());
	}
