 ...
 * @generated
 */
public class RBACDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RBACDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof RBACDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((RBACDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new RBACDomainNavigatorItem((EObject) objects[i],
