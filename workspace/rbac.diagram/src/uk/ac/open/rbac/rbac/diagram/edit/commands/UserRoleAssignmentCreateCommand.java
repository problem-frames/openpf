 ...
 * @generated
 */
public class UserRoleAssignmentCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public UserRoleAssignmentCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof User) {
			return false;
		}
		...
		return RBACBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateUserRoleAssignment_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		UserRoleAssignment newElement = RbacFactory.eINSTANCE
				.createUserRoleAssignment();
		getContainer().getAssignments().add(newElement);
		newElement.setUser(getSource());
		newElement.setRole(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(UserRoleAssignment newElement,
