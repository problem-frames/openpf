...
import uk.ac.open.rbac.rbac.diagram.part.RBACDiagramEditor;
 ...
 * @generated
 */
public class RBACNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof RBACNavigatorItem) {
					selectedElement = ((RBACNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, RBACDiagramEditor.ID);
