...
import uk.ac.open.rbac.rbac.diagram.edit.policies.ModelCanonicalEditPolicy;
import uk.ac.open.rbac.rbac.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "RBAC"; //$NON-NLS-1$
