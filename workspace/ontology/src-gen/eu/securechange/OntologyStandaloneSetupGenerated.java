...
public class OntologyStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new eu.securechange.OntologyRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://securechange.eu/ontology")) {
		EPackage.Registry.INSTANCE.put("http://securechange.eu/ontology", eu.securechange.ontology.OntologyPackage.eINSTANCE);
	}
