...
public class OntologySwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        eu.securechange.ontology.Object object = (eu.securechange.ontology.Object)theEObject;
        T result = caseObject(object);
        if (result == null) result = caseThing(object);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OntologyPackage.PHYSICAL_WORLD:
      {
      ...
      case OntologyPackage.BELIEF_WORLD:
      {
      ...
      {
        eu.securechange.ontology.Process process = (eu.securechange.ontology.Process)theEObject;
   ...
   * @generated
   */
  public T caseObject(eu.securechange.ontology.Object object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseProcess(eu.securechange.ontology.Process object)
  {
    return null;
  }
