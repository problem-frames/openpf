 ...
 * <ul>
 *   <li>{@link eu.securechange.ontology.World#getPhysical <em>Physical</em>}</li>
 *   <li>{@link eu.securechange.ontology.World#getBelief <em>Belief</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.securechange.ontology.OntologyPackage#getWorld()
 * @model
 * @generated
 */
public interface World extends EObject
{
   ...
   * @see eu.securechange.ontology.OntologyPackage#getWorld_Physical()
  ...
  /**
   * Sets the value of the '{@link eu.securechange.ontology.World#getPhysical <em>Physical</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.securechange.ontology.OntologyPackage#getWorld_Belief()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link eu.securechange.ontology.World#getBelief <em>Belief</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
