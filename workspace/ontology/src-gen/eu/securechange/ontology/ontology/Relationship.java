 ...
 *   <li>{@link eu.securechange.ontology.ontology.Relationship#getDependum <em>Dependum</em>}</li>
...
public interface Relationship extends EObject
{
   ...
   * @see #setDependum(Entity)
   * @see eu.securechange.ontology.ontology.OntologyPackage#getRelationship_Dependum()
   * @model
   * @generated
   */
  Entity getDependum();
  ...
  /**
   * Sets the value of the '{@link eu.securechange.ontology.ontology.Relationship#getDependum <em>Dependum</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
