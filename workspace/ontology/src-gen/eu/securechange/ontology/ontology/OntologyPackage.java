...
public interface OntologyPackage extends EPackage
{
   ...
   * @ordered
   */
  int RELATIONSHIP__PROPERTIES = 4;
  ...
  /**
   * Returns the meta object for the reference '{@link eu.securechange.ontology.ontology.Relationship#getDependum <em>Dependum</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Dependum</em>'.
   * @see eu.securechange.ontology.ontology.Relationship#getDependum()
   * @see #getRelationship()
   * @generated
   */
  EReference getRelationship_Dependum();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference RELATIONSHIP__DEPENDUM = eINSTANCE.getRelationship_Dependum();
