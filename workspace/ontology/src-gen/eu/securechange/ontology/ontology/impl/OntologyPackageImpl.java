...
public class OntologyPackageImpl extends EPackageImpl implements OntologyPackage
{
   ...
   * @generated
   */
  public EReference getWorld_Goals()
  {
   ...
   * @generated
   */
  public EReference getGoal_Properties()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(worldEClass, WORLD__GOALS);
    ...
    createEReference(goalEClass, GOAL__PROPERTIES);
  ...
  public void initializePackageContents()
  {
    ...
    antiRequirementEClass.getESuperTypes().add(this.getGoal());
    actorEClass.getESuperTypes().add(this.getDomain());
    actionEClass.getESuperTypes().add(this.getDomain());
    assetEClass.getESuperTypes().add(this.getDomain());
    resourceEClass.getESuperTypes().add(this.getDomain());
    attackerEClass.getESuperTypes().add(this.getDomain());
    ...
    initEReference(getWorld_Goals(), this.getGoal(), null, "goals", null, 0, -1, World.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getGoal_Type(), ecorePackage.getEString(), "type", null, 0, 1, Goal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGoal_Properties(), this.getProposition(), null, "properties", null, 0, -1, Goal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRelationship_Source(), this.getWorld(), null, "source", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationship_Target(), this.getWorld(), null, "target", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
