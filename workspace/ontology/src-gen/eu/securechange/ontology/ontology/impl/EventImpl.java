 ...
 * <ul>
 *   <li>{@link eu.securechange.ontology.ontology.impl.EventImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventImpl extends ThingImpl implements Event
{
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologyPackage.EVENT__NAME, oldName, name));
	}
  ...
  {
		switch (featureID) {
			case OntologyPackage.EVENT__NAME:
				return getName();
		}
