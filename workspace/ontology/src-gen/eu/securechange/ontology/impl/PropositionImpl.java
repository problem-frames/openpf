 ...
 * <ul>
 *   <li>{@link eu.securechange.ontology.impl.PropositionImpl#getType <em>Type</em>}</li>
 *   <li>{@link eu.securechange.ontology.impl.PropositionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropositionImpl extends ObjectImpl implements Proposition
{
  ...
  public void setType(PropositionType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OntologyPackage.PROPOSITION__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OntologyPackage.PROPOSITION__TYPE:
        return getType();
