 ...
 * <ul>
 *   <li>{@link eu.securechange.ontology.impl.FulfilsImpl#getType <em>Type</em>}</li>
 *   <li>{@link eu.securechange.ontology.impl.FulfilsImpl#getSource <em>Source</em>}</li>
 *   <li>{@link eu.securechange.ontology.impl.FulfilsImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FulfilsImpl extends RelationshipImpl implements Fulfils
{
   ...
   * @ordered
   */
  protected eu.securechange.ontology.Process source;
   ...
   * @generated
   */
  public eu.securechange.ontology.Process getSource()
  {
    if (source != null && source.eIsProxy())
    {
      InternalEObject oldSource = (InternalEObject)source;
      source = (eu.securechange.ontology.Process)eResolveProxy(oldSource);
      if (source != oldSource)
      {
        if (eNotificationRequired())
   ...
   * @generated
   */
  public eu.securechange.ontology.Process basicGetSource()
  {
    return source;
  }
   ...
   * @generated
   */
  public void setSource(eu.securechange.ontology.Process newSource)
  {
    eu.securechange.ontology.Process oldSource = source;
    source = newSource;
    if (eNotificationRequired())
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case OntologyPackage.FULFILS__TYPE:
        ...
        return;
      case OntologyPackage.FULFILS__SOURCE:
        setSource((eu.securechange.ontology.Process)newValue);
        return;
      case OntologyPackage.FULFILS__TARGET:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case OntologyPackage.FULFILS__TYPE:
        ...
        return;
      case OntologyPackage.FULFILS__SOURCE:
        setSource((eu.securechange.ontology.Process)null);
        return;
      case OntologyPackage.FULFILS__TARGET:
