 ...
 * @generated
 */
public class ProblemDiagramItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProblemPackage.Literals.PROBLEM_DIAGRAM__NODES);
			childrenFeatures.add(ProblemPackage.Literals.PROBLEM_DIAGRAM__LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProblemPackage.Literals.PROBLEM_DIAGRAM__NODES,
				 ProblemFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(ProblemPackage.Literals.PROBLEM_DIAGRAM__LINKS,
				 ProblemFactory.eINSTANCE.createLink()));
	}
