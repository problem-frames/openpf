...
/**
 * This is the item provider adapter for a {@link uk.ac.open.event.eventcalculus.Var} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EventcalculusPackage.Literals.VAR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Var_min_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Var_min_feature", "_UI_Var_type"),
				 EventcalculusPackage.Literals.VAR__MIN,
				 true,
				 false,
				 false,
	...
	protected void addMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Var_max_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Var_max_feature", "_UI_Var_type"),
				 EventcalculusPackage.Literals.VAR__MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
