...
/**
 * This is the item provider adapter for a {@link uk.ac.open.event.eventcalculus.Term} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EventcalculusPackage.Literals.TERM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addArgsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Term_args_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Term_args_feature", "_UI_Term_type"),
				 EventcalculusPackage.Literals.TERM__ARGS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
