...
/**
 * This is the item provider adapter for a {@link uk.ac.open.event.eventcalculus.Sort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sort_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sort_name_feature", "_UI_Sort_type"),
				 EventcalculusPackage.Literals.SORT__NAME,
				 true,
				 false,
				 false,
