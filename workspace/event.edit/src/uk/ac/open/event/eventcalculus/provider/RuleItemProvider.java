...
/**
 * This is the item provider adapter for a {@link uk.ac.open.event.eventcalculus.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EventcalculusPackage.Literals.RULE__DECL);
			childrenFeatures.add(EventcalculusPackage.Literals.RULE__EXPR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EventcalculusPackage.Literals.RULE__DECL,
				 EventcalculusFactory.eINSTANCE.createVarDecl()));

		newChildDescriptors.add
			(createChildParameter
				(EventcalculusPackage.Literals.RULE__EXPR,
