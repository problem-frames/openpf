...
/**
 * This is the item provider adapter for a {@link uk.ac.open.event.eventcalculus.BinaryBoolExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryBoolExprItemProvider
	 ...
	 * @generated
	 */
	public BinaryBoolExprItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryBoolExpr_binaryop_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryBoolExpr_binaryop_feature", "_UI_BinaryBoolExpr_type"),
				 EventcalculusPackage.Literals.BINARY_BOOL_EXPR__BINARYOP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EventcalculusPackage.Literals.BINARY_BOOL_EXPR__OPR);
		}
	...
	/**
	 * This returns BinaryBoolExpr.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BinaryBoolExpr"));
	}
	...
	public String getText(Object object) {
		BinaryBoolOp labelValue = ((BinaryBoolExpr)object).getBinaryop();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_BinaryBoolExpr_type") :
			getString("_UI_BinaryBoolExpr_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BinaryBoolExpr.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EventcalculusPackage.Literals.BINARY_BOOL_EXPR__OPR,
