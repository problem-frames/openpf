...
/**
 * This is the item provider adapter for a {@link uk.ac.open.event.eventcalculus.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_File_names_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_File_names_feature", "_UI_File_type"),
				 EventcalculusPackage.Literals.FILE__NAMES,
				 true,
				 false,
				 false,
