...
/**
 * This is the item provider adapter for a {@link uk.ac.open.rbac.rbac.Session} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SessionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Session_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Session_name_feature", "_UI_Session_type"),
				 RbacPackage.Literals.SESSION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RbacPackage.Literals.SESSION__ASSIGNMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Session.class)) {
			case RbacPackage.SESSION__NAME:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RbacPackage.Literals.SESSION__ASSIGNMENTS,
