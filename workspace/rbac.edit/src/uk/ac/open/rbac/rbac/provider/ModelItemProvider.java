...
/**
 * This is the item provider adapter for a {@link uk.ac.open.rbac.rbac.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RbacPackage.Literals.MODEL__ROLES);
			childrenFeatures.add(RbacPackage.Literals.MODEL__USERS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RbacPackage.Literals.MODEL__ROLES,
				 RbacFactory.eINSTANCE.createRole()));

		newChildDescriptors.add
			(createChildParameter
				(RbacPackage.Literals.MODEL__USERS,
				 RbacFactory.eINSTANCE.createUser()));

		newChildDescriptors.add
			(createChildParameter
				(RbacPackage.Literals.MODEL__SESSIONS,
				 RbacFactory.eINSTANCE.createSession()));

		newChildDescriptors.add
			(createChildParameter
				(RbacPackage.Literals.MODEL__OBJECTS,
				 RbacFactory.eINSTANCE.createObject()));
