...
* generated by Xtext
*/
package uk.ac.open.istar.contentassist.antlr;
...
public class IstarParser extends AbstractContentAssistParser {
	...
	@Override
	protected uk.ac.open.istar.contentassist.antlr.internal.InternalIstarLexer createLexer(CharStream stream) {
		return new uk.ac.open.istar.contentassist.antlr.internal.InternalIstarLexer(stream);
	}
	
	@Override
	protected uk.ac.open.istar.contentassist.antlr.internal.InternalIstarParser createParser() {
		uk.ac.open.istar.contentassist.antlr.internal.InternalIstarParser result = new uk.ac.open.istar.contentassist.antlr.internal.InternalIstarParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			uk.ac.open.istar.contentassist.antlr.internal.InternalIstarParser typedParser = (uk.ac.open.istar.contentassist.antlr.internal.InternalIstarParser) parser;
