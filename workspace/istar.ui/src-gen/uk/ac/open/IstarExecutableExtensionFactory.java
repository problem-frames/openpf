...
public class IstarExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		uk.ac.open.internal.IstarActivator instance = uk.ac.open.internal.IstarActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = uk.ac.open.internal.IstarActivator.getInstance().getInjector("uk.ac.open.Istar");
