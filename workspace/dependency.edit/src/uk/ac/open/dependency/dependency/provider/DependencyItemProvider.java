...
/**
 * This is the item provider adapter for a {@link uk.ac.open.dependency.dependency.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DependencyPackage.Literals.DEPENDENCY__FROM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DependencyPackage.Literals.DEPENDENCY__TO,
				 true,
				 false,
				 true,
				 null,
