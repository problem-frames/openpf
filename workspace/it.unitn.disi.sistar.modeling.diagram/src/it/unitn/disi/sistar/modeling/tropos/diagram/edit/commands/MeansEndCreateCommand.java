...
public class MeansEndCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateMeansEnd_3006(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		MeansEnd newElement = TroposFactory.eINSTANCE.createMeansEnd();
	...
	protected void doConfigure(MeansEnd newElement, IProgressMonitor monitor,
		...
		TroposElementConfiguration.configureMeansEnd(newElement, getRequest());
	}
