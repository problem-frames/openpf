 ...
 * @generated
 */
public class ServiceRemarksLabel2EditPart extends TroposExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(TroposVisualIDRegistry
				.getType(ServiceRemarksLabel2EditPart.VISUAL_ID), new Point(0,
				0));
	}
	 ...
	 * @generated
	 */
	public ServiceRemarksLabel2EditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return TroposElementTypes.Service_1002;
					}
	...
	protected IFigure createFigurePrim() {
		return new ServiceRemarksFigure();
	}

	/**
	 * @generated
	 */
	public class ServiceRemarksFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public ServiceRemarksFigure() {
