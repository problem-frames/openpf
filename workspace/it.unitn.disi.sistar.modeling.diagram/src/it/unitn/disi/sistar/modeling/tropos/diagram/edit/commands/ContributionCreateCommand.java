...
public class ContributionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateContribution_3002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Contribution newElement = TroposFactory.eINSTANCE.createContribution();
	...
	protected void doConfigure(Contribution newElement,
		...
		TroposElementConfiguration.configureContribution(newElement, getRequest());
	}
