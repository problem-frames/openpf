...
public class AssociationNameEditPart extends LabelEditPart implements
	 ...
	 */
	static {
		registerSnapBackPosition(TroposVisualIDRegistry
				.getType(AssociationNameEditPart.VISUAL_ID), new Point(0, 0));
	}
			...
			parser = TroposParserProvider
					.getParser(
							...
							TroposVisualIDRegistry
									.getType(it.unitn.disi.sistar.modeling.tropos.diagram.edit.parts.AssociationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	public class AssociationLabelFigure extends WrappingLabel {
		...
		public AssociationLabelFigure() {
			EAssociationType type = (EAssociationType) ((Association) getPrimaryView()
					.getElement()).eGet(TroposPackage.eINSTANCE
					.getAssociation_AssociationType());
			this.setText(AssociationTypeMapper.mapAttribute(type));
			createContents();
		}
