...
public class ActorNameEditPart extends CompartmentEditPart implements
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TroposParserProvider
					.getParser(
							TroposElementTypes.Actor_1001,
							getParserElement(),
							TroposVisualIDRegistry
									.getType(it.unitn.disi.sistar.modeling.tropos.diagram.edit.parts.ActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void refreshFontColor() {
		FontStyle fontStyle = (FontStyle) getPrimaryView().getStyle(
				NotationPackage.eINSTANCE.getFontStyle());
		Color fontColor = null;
		if (fontStyle
				.eIsSet(NotationPackage.eINSTANCE.getFontStyle_FontColor()))
			fontColor = DiagramColorRegistry.getInstance().getColor(
					new Integer(fontStyle.getFontColor()));

		setFontColor(ColorSchemaUtil.getColorPreference(
				PreferenceConstants.COLOR_ACTOR_FONT, fontColor));
	}
