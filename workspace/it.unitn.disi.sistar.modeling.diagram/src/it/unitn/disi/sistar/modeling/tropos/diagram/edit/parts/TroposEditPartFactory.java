 ...
 * @generated
 */
public class TroposEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case Service2EditPart.VISUAL_ID:
				return new Service2EditPart(view);

			case ServiceName2EditPart.VISUAL_ID:
				return new ServiceName2EditPart(view);
			...
			case ContributionNameEditPart.VISUAL_ID:
				return new ContributionNameEditPart(view);
			...
			case OwnershipEditPart.VISUAL_ID:
				return new OwnershipEditPart(view);
