...
public class ServiceCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Service newElement = TroposFactory.eINSTANCE.createService();

		Actor owner = (Actor) getElementToEdit();
	...
	protected void doConfigure(Service newElement, IProgressMonitor monitor,
		...
		/*
		 * see ActorCreateCommand.doConfigure() for information
		 */
		TroposElementConfiguration.configureService(newElement, getRequest(),
				true);
	}
