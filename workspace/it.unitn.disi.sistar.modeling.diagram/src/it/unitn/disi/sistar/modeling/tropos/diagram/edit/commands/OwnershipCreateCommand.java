 ...
 * @generated
 */
public class OwnershipCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OwnershipCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof GraphicalObject) {
			return false;
		}
		if (target != null && false == target instanceof GraphicalObject) {
			return false;
		}
		if (getSource() == null) {
		...
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateOwnership_3005(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Ownership newElement = TroposFactory.eINSTANCE.createOwnership();
	 ...
	 * @generated NOT
	 */
	protected void doConfigure(Ownership newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
		...
		//minhsang: need to configure this element after creating
		TroposElementConfiguration.configureOwership(newElement, getRequest());
	}
	 ...
	 * @generated
	 */
	protected GraphicalObject getSource() {
		return (GraphicalObject) source;
	}

	/**
	 * @generated
	 */
	protected GraphicalObject getTarget() {
		return (GraphicalObject) target;
	}
