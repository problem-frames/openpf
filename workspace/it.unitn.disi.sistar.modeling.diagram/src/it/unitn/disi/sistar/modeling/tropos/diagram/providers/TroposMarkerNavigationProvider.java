...
import it.unitn.disi.sistar.modeling.tropos.diagram.part.TroposDiagramEditorUtil;
 ...
 * @generated
 */
public class TroposMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {
	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = TroposDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			TroposDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
