...
public class DependencyCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateDependency_3004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Dependency newElement = TroposFactory.eINSTANCE.createDependency();
	...
	protected void doConfigure(Dependency newElement, IProgressMonitor monitor,
		...
		// minhsang: configure new created dependency
		TroposElementConfiguration.configureDependency(newElement,
				getRequest());
