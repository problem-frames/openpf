 ...
 * @generated
 */
public abstract class TroposAbstractExpression {
	/**
	 * @generated
	 */
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = TroposDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected TroposAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
}
