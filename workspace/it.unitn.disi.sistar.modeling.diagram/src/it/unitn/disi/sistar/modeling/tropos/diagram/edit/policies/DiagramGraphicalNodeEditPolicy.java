...
public class DiagramGraphicalNodeEditPolicy extends TroposGraphicalNodeEditPolicy {
	@Override
	...
	protected Command getConnectionCompleteCommand(CreateConnectionRequest request) {
		...
		if((extendedData.containsKey(CreateContributionTool.CONTRIBUTION_TYPE)||extendedData.containsKey(CreateCompositionTool.COMPOSITION_TYPE))&& request.getType().equals(RequestConstants.REQ_CONNECTION_END) 
				&& request.getSourceEditPart() instanceof ServiceEditPart && request.getTargetEditPart() instanceof DiagramEditPart)
		{
			...
			Command midServiceCommand = ((DiagramEditPart)getHost()).getCommand(midServiceRequest);
