 ...
 * @generated
 */
public class ServiceRemarksLabelEditPart extends TroposExtNodeLabelEditPart
	 ...
	 * @generated
	 */
	public ServiceRemarksLabelEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return TroposElementTypes.Service_2001;
					}
