 ...
 * @generated
 */
public class TroposStructuralFeatureParser extends TroposAbstractParser {
	 ...
	 * @generated
	 */
	public TroposStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(TroposDiagramEditorPlugin.ID,
