 ...
 * @generated
 */
public class CustomRelationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CustomRelationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof CustomRelation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCustomRelation_3007(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Diagram container = (Diagram) getLink().eContainer();
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCustomRelation_3007(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected CustomRelation getLink() {
		return (CustomRelation) getElementToEdit();
	}
