 ...
 * @generated
 */
public class OwnershipReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OwnershipReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Ownership) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canExistOwnership_3005(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Diagram container = (Diagram) getLink().eContainer();
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canExistOwnership_3005(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Ownership getLink() {
		return (Ownership) getElementToEdit();
	}
