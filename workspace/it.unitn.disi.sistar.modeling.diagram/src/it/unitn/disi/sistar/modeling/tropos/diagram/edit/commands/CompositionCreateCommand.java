...
public class CompositionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CompositionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return TroposBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateComposition_3003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Composition newElement = TroposFactory.eINSTANCE.createComposition();
	 ...
	 * @generated NOT
	 */
	protected void doConfigure(Composition newElement,
		...
		TroposElementConfiguration.configureComposition(newElement, getRequest());
	}
