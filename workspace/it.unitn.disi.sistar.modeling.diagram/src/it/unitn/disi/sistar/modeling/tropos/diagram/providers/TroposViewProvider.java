 ...
 * @generated
 */
public class TroposViewProvider extends AbstractProvider implements
		IViewProvider {

	public TroposViewProvider() {
	 ...
	 * bug fix: can not create goal outside actor's compartment
	 * @generated NOT
	 */
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TroposVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = TroposVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!TroposElementTypes.isKnownElementType(elementType)
				...
				//minhsang: the semanticHint() for create a goal is 2001,
				// but when user puts this goal outside any actor, the VisualID
				// of the editpart is 1002, so we are unable to create view node
				// for goal outside actor's compartment.
				int nodeVisualID = TroposVisualIDRegistry.getNodeVisualID(op.getContainerView(),
						domainElement);
				if (nodeVisualID == Service2EditPart.VISUAL_ID)
					nodeVisualID = ServiceEditPart.VISUAL_ID;
				
				if (domainElement != null
						&& visualID != nodeVisualID) {
		...
		return ActorEditPart.VISUAL_ID == visualID
				|| Service2EditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = TroposVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != TroposVisualIDRegistry
	...
	/**
	 * customized by minhsang
	 * for backward compatibility, after a node is created, we create appropriate
	 * style for this node.  
	 * @generated NOT
	 */
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = TroposVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = TroposVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ActorEditPart.VISUAL_ID:
			return createStyle(createActor_1001(domainElement, containerView,
					index, persisted, preferencesHint), visualID);
		case Service2EditPart.VISUAL_ID:
			return createStyle(createService_1002(domainElement, containerView,
					index, persisted, preferencesHint), visualID);
		case ServiceEditPart.VISUAL_ID:
			return createStyle(createService_2001(domainElement, containerView,
					index, persisted, preferencesHint), visualID);
		}
	 ...
	 * @author minhsang
	 */
	protected Node createStyle(Node node, int visualID) {
		...
		switch (visualID) {
		case ActorEditPart.VISUAL_ID:
			ActorStyle actorStyle = CustomStyleFactory.eINSTANCE
					.createActorStyle();
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (TroposVisualIDRegistry.getVisualID(elementTypeHint)) {
		case AssociationEditPart.VISUAL_ID:
			return createAssociation_3001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ContributionEditPart.VISUAL_ID:
			return createContribution_3002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case CompositionEditPart.VISUAL_ID:
			return createComposition_3003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case DependencyEditPart.VISUAL_ID:
			return createDependency_3004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case OwnershipEditPart.VISUAL_ID:
			return createOwnership_3005(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case MeansEndEditPart.VISUAL_ID:
			return createMeansEnd_3006(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case CustomRelationEditPart.VISUAL_ID:
			return createCustomRelation_3007(
	...
	public Node createActor_1001(EObject domainElement, View containerView,
		...
		node.setType(TroposVisualIDRegistry.getType(ActorEditPart.VISUAL_ID));
		...
		Node label4002 = createLabel(node, TroposVisualIDRegistry
				.getType(ActorNameEditPart.VISUAL_ID));
		createCompartment(node, TroposVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createService_1002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node
				.setType(TroposVisualIDRegistry
						.getType(Service2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label4003 = createLabel(node, TroposVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createService_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TroposVisualIDRegistry.getType(ServiceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label4001 = createLabel(node, TroposVisualIDRegistry
	 ...
	 * @generated NOT
	 */
	public Edge createAssociation_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createConnector(); //minhsang
		...
		edge.setType(TroposVisualIDRegistry
		...
		Node label4004 = createLabel(edge, TroposVisualIDRegistry
	 ...
	 * @generated NOT
	 */
	public Edge createContribution_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createConnector(); //minhsang
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		Node label4005 = createLabel(edge, TroposVisualIDRegistry
	 ...
	 * @generated NOT
	 */
	public Edge createComposition_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createConnector(); // minhsang
	 ...
	 * @generated NOT
	 */
	public Edge createDependency_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		
		EList styles = edge.getStyles();
	 ...
	 * @generated
	 */
	public Edge createOwnership_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TroposVisualIDRegistry
				.getType(OwnershipEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated NOT
	 */
	public Edge createMeansEnd_3006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		//minhsang, createConnector() instead of createEdge allows users to change line color
		Edge edge = NotationFactory.eINSTANCE.createConnector(); 
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
				.createRelativeBendpoints();
		...
		edge
				.setType(TroposVisualIDRegistry
						.getType(MeansEndEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createCustomRelation_3007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TroposVisualIDRegistry
				.getType(CustomRelationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	private Node createCompartment(View owner, String hint,
		...
		if (canCollapse) {
			...
			/*
			 * minhsang, for some reasons the default Collapsed is false
			 * --> for the first time user collapse the compartment 
			 * --> remember wrong boundary information
			 */
			((DrawerStyle) rv).setCollapsed(true);
		} else {
