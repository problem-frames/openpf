...
import it.unitn.disi.sistar.modeling.tropos.diagram.edit.policies.TroposTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ContributionNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TroposVisualIDRegistry
						.getType(it.unitn.disi.sistar.modeling.tropos.diagram.edit.parts.ContributionNameEditPart.VISUAL_ID),
				new Point(0, 5));
	}
	 ...
	 * @generated
	 */
	public ContributionNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new TroposTextSelectionEditPolicy());
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof TroposTextSelectionEditPolicy) {
			((TroposTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof TroposTextSelectionEditPolicy) {
			((TroposTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), TroposEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new ContributionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContributionLabelFigure extends WrappingLabel {

		/**
		 * @generated NOT
		 */
		public ContributionLabelFigure() {

			Contribution contribution = ((Contribution) getPrimaryView()
					.getElement());
			EContributionType type = contribution.getContributionType();
			ESATType satType = contribution.getSatType();
			double weight = contribution.getWeight();
			this.setText(ContributionTypeMapper.mapAttribute(type, satType,
					weight));
