...
import it.unitn.disi.sistar.modeling.tropos.diagram.part.TroposDiagramEditor;
 ...
 * @generated
 */
public class TroposNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof TroposNavigatorItem) {
					selectedElement = ((TroposNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, TroposDiagramEditor.ID);
