 ...
 * generated
 */
public class EventCalculusExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(EventCalculusExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		uk.ac.open.event.internal.EventCalculusActivator instance = uk.ac.open.event.internal.EventCalculusActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = uk.ac.open.event.internal.EventCalculusActivator.getInstance().getInjector("uk.ac.open.event.EventCalculus");
