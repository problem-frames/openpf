 ...
 * <ul>
 *   <li>{@link uk.ac.open.argument.argument.Mitigates#getLabel <em>Label</em>}</li>
...
public interface Mitigates extends Link
{
   ...
   * @see #setLabel(String)
   * @see uk.ac.open.argument.argument.ArgumentPackage#getMitigates_Label()
   * @model
   * @generated
   */
  String getLabel();
  ...
  /**
   * Sets the value of the '{@link uk.ac.open.argument.argument.Mitigates#getLabel <em>Label</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
