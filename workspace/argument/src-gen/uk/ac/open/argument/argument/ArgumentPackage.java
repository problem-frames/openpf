...
public interface ArgumentPackage extends EPackage
{
   ...
   * @ordered
   */
  int MITIGATES__LABEL = LINK_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the attribute '{@link uk.ac.open.argument.argument.Mitigates#getLabel <em>Label</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Label</em>'.
   * @see uk.ac.open.argument.argument.Mitigates#getLabel()
   * @see #getMitigates()
   * @generated
   */
  EAttribute getMitigates_Label();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute MITIGATES__LABEL = eINSTANCE.getMitigates_Label();
