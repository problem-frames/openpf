 ...
 * <ul>
 *   <li>{@link uk.ac.open.argument.argument.impl.ExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link uk.ac.open.argument.argument.impl.ExpressionImpl#getOp <em>Op</em>}</li>
...
public class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression
{
  ...
  public NotificationChain basicSetExpr(Expression newExpr, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ArgumentPackage.EXPRESSION__EXPR, oldExpr, newExpr);
  ...
  public void setExpr(Expression newExpr)
  {
    if (newExpr != expr)
    {
      ...
      if (expr != null)
        msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ArgumentPackage.EXPRESSION__EXPR, null, msgs);
      if (newExpr != null)
        msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ArgumentPackage.EXPRESSION__EXPR, null, msgs);
      msgs = basicSetExpr(newExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArgumentPackage.EXPRESSION__EXPR, newExpr, newExpr));
  }
  ...
  public void setOp(UnaryOp newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArgumentPackage.EXPRESSION__OP, oldOp, op));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArgumentPackage.EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ArgumentPackage.EXPRESSION__EXPR:
        return getExpr();
      case ArgumentPackage.EXPRESSION__OP:
        return getOp();
      case ArgumentPackage.EXPRESSION__RIGHT:
        return getRight();
