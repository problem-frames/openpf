...
public class InternalArgumentParser extends AbstractInternalAntlrParser {
    ...
    // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:612:1: ruleMitigates returns [EObject current=null] : ( ( ( RULE_ID ) ) 'mitigated by' ( ( RULE_ID ) ) 'on' ( ( RULE_ID ) ) ) ;
    public final EObject ruleMitigates() throws RecognitionException {
        ...
        try {
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:617:6: ( ( ( ( RULE_ID ) ) 'mitigated by' ( ( RULE_ID ) ) 'on' ( ( RULE_ID ) ) ) )
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:618:1: ( ( ( RULE_ID ) ) 'mitigated by' ( ( RULE_ID ) ) 'on' ( ( RULE_ID ) ) )
            {
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:618:1: ( ( ( RULE_ID ) ) 'mitigated by' ( ( RULE_ID ) ) 'on' ( ( RULE_ID ) ) )
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:618:2: ( ( RULE_ID ) ) 'mitigated by' ( ( RULE_ID ) ) 'on' ( ( RULE_ID ) )
            {
            ...
            match(input,28,FOLLOW_28_in_ruleMitigates1039); 

                    createLeafNode(grammarAccess.getMitigatesAccess().getOnKeyword_3(), null); 
                
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:654:1: ( ( RULE_ID ) )
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:655:1: ( RULE_ID )
            {
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:655:1: ( RULE_ID )
            // ../argument/src-gen/uk/ac/open/argument/parser/antlr/internal/InternalArgument.g:656:3: RULE_ID
            {
            ...
            match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleMitigates1057); 
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleMitigates1029 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_28_in_ruleMitigates1039 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleMitigates1057 = new BitSet(new long[]{0x0000000000000002L});
