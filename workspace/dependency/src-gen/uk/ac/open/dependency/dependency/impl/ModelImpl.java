 ...
 * <ul>
 *   <li>{@link uk.ac.open.dependency.dependency.impl.ModelImpl#getName <em>Name</em>}</li>
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DependencyPackage.MODEL__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DependencyPackage.MODEL__NAME:
        return getName();
      case DependencyPackage.MODEL__NODES:
        return getNodes();
      case DependencyPackage.MODEL__DEPENDENCIES:
