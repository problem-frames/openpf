...
public interface DependencyPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute '{@link uk.ac.open.dependency.dependency.Model#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see uk.ac.open.dependency.dependency.Model#getName()
   * @see #getModel()
   * @generated
   */
