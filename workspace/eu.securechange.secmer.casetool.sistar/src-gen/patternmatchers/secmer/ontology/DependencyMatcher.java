/*******************************************************************************
 * EMF Specific API of the secmer.ontology.dependency pattern
...
import signatures.secmer.ontology.DependencySignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.dependency pattern
 */
public class DependencyMatcher extends BaseGeneratedMatcher<DependencySignature> implements IncQueryMatcher<DependencySignature>{
	 ...
	 */
	public DependencyMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DependencyMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DependencyMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DependencyMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param DependencyType the fixed value of pattern parameter DependencyType, or null if not bound.
	 * @param Dependum the fixed value of pattern parameter Dependum, or null if not bound.
	 * @return matches represented as a DependencySignature object.
	 */
	public Collection<DependencySignature> getAllMatchesAsObject(Object Act1, Object Act2, Object DependencyType, Object Dependum) {
	 ...
	 * @param DependencyType the fixed value of pattern parameter DependencyType, or null if not bound.
	 * @param Dependum the fixed value of pattern parameter Dependum, or null if not bound.
	 * @return a match represented as a DependencySignature object, or null if no match is found.
	 */
	public DependencySignature getOneMatchAsObject(Object Act1, Object Act2, Object DependencyType, Object Dependum) {
	...
	public String getPatternName() {
		return "secmer.ontology.dependency";
	}
	 ...
	 */
	@Override
	protected DependencySignature tupleToSignature(Tuple t) {
		return new DependencySignature(t.get(0), t.get(1), t.get(2), t.get(3));
	}
	 ...
	 */
	@Override
	public DependencySignature arrayToSignature(Object[] signature) {
		return new DependencySignature(signature[0], signature[1], signature[2], signature[3]);
	}	
