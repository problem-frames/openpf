/*******************************************************************************
 * EMF Specific API of the secmer.ontology.trust pattern
...
import signatures.secmer.ontology.TrustSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.trust pattern
 */
public class TrustMatcher extends BaseGeneratedMatcher<TrustSignature> implements IncQueryMatcher<TrustSignature>{
	 ...
	 */
	public Collection<TrustSignature> getAllMatchesAsObject(Object Act1, Object Act2, Object Dependum) {
	 ...
	 */
	public TrustSignature getOneMatchAsObject(Object Act1, Object Act2, Object Dependum) {
	...
	protected TrustSignature tupleToSignature(Tuple t) {
		return new TrustSignature(t.get(0), t.get(1), t.get(2));
	}
	...
	public TrustSignature arrayToSignature(Object[] signature) {
		return new TrustSignature(signature[0], signature[1], signature[2]);
	}	
