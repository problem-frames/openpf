/*******************************************************************************
 * EMF Specific API of the secmer.ontology.canDelegation pattern
...
import signatures.secmer.ontology.CanDelegationSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.canDelegation pattern
 */
public class CanDelegationMatcher extends BaseGeneratedMatcher<CanDelegationSignature> implements IncQueryMatcher<CanDelegationSignature>{
	 ...
	 */
	public Collection<CanDelegationSignature> getAllMatchesAsObject(Object Act1, Object Act2, Object Dependum) {
	 ...
	 */
	public CanDelegationSignature getOneMatchAsObject(Object Act1, Object Act2, Object Dependum) {
	...
	public String getPatternName() {
		return "secmer.ontology.canDelegation";
	}
	...
	protected CanDelegationSignature tupleToSignature(Tuple t) {
		return new CanDelegationSignature(t.get(0), t.get(1), t.get(2));
	}
	...
	public CanDelegationSignature arrayToSignature(Object[] signature) {
		return new CanDelegationSignature(signature[0], signature[1], signature[2]);
	}	
