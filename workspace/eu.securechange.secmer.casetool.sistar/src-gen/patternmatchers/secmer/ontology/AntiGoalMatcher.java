/*******************************************************************************
 * EMF Specific API of the secmer.ontology.antiGoal pattern
...
import signatures.secmer.ontology.AntiGoalSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.ontology.antiGoal pattern
 */
public class AntiGoalMatcher extends BaseGeneratedMatcher<AntiGoalSignature> implements IncQueryMatcher<AntiGoalSignature>{
	 ...
	 */
	public AntiGoalMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public AntiGoalMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public AntiGoalMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public AntiGoalMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * Returns the set of all pattern matches given some fixed parameters.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return matches represented as a AntiGoalSignature object.
	 */
	public Collection<AntiGoalSignature> getAllMatchesAsObject(Object Goal) {
	 ...
	 * Neither determinism nor randomness of selection is guaranteed.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return a match represented as a AntiGoalSignature object, or null if no match is found.
	 */
	public AntiGoalSignature getOneMatchAsObject(Object Goal) {
	...
	public String getPatternName() {
		return "secmer.ontology.antiGoal";
	}
	 ...
	 */
	@Override
	protected AntiGoalSignature tupleToSignature(Tuple t) {
		return new AntiGoalSignature(t.get(0));
	}
	 ...
	 */
	@Override
	public AntiGoalSignature arrayToSignature(Object[] signature) {
		return new AntiGoalSignature(signature[0]);
	}	
