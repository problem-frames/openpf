/*******************************************************************************
 * EMF Specific API of the secmer.sistar.transform.actorMappingToTroposWithName pattern
...
import signatures.secmer.sistar.transform.ActorMappingToTroposWithNameSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.transform.actorMappingToTroposWithName pattern
 */
public class ActorMappingToTroposWithNameMatcher extends BaseGeneratedMatcher<ActorMappingToTroposWithNameSignature> implements IncQueryMatcher<ActorMappingToTroposWithNameSignature>{
	 ...
	 */
	public ActorMappingToTroposWithNameMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingToTroposWithNameMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingToTroposWithNameMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingToTroposWithNameMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Link, Object Name) {
		return getAllMatchesAsArray(new Object[] {Actor, Link, Name});
	}
	 ...
	 * @param Link the fixed value of pattern parameter Link, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return matches represented as a ActorMappingToTroposWithNameSignature object.
	 */
	public Collection<ActorMappingToTroposWithNameSignature> getAllMatchesAsObject(Object Actor, Object Link, Object Name) {
		return getAllMatchesAsObject(new Object[] {Actor, Link, Name});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Link, Object Name) {
		return getOneMatchAsArray(new Object[] {Actor, Link, Name});
	}
	 ...
	 * @param Link the fixed value of pattern parameter Link, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return a match represented as a ActorMappingToTroposWithNameSignature object, or null if no match is found.
	 */
	public ActorMappingToTroposWithNameSignature getOneMatchAsObject(Object Actor, Object Link, Object Name) {
		return getOneMatchAsObject(new Object[] {Actor, Link, Name});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Link, Object Name) {
		return hasMatch(new Object[] {Actor, Link, Name});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Link, Object Name) {
		return countMatches(new Object[] {Actor, Link, Name});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.transform.actorMappingToTroposWithName";
	}

	private static final String[] paramNames = new String[] {"Actor", "Link", "Name"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorMappingToTroposWithNameSignature tupleToSignature(Tuple t) {
		return new ActorMappingToTroposWithNameSignature(t.get(0), t.get(1), t.get(2));
	}
	 ...
	 */
	@Override
	public ActorMappingToTroposWithNameSignature arrayToSignature(Object[] signature) {
		return new ActorMappingToTroposWithNameSignature(signature[0], signature[1], signature[2]);
	}	
