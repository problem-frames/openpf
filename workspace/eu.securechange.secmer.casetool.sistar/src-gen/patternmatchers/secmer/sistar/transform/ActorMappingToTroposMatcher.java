/*******************************************************************************
 * EMF Specific API of the secmer.sistar.transform.actorMappingToTropos pattern
...
import signatures.secmer.sistar.transform.ActorMappingToTroposSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.transform.actorMappingToTropos pattern
 */
public class ActorMappingToTroposMatcher extends BaseGeneratedMatcher<ActorMappingToTroposSignature> implements IncQueryMatcher<ActorMappingToTroposSignature>{
	 ...
	 */
	public ActorMappingToTroposMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingToTroposMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingToTroposMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingToTroposMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Link) {
		return getAllMatchesAsArray(new Object[] {Actor, Link});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Link the fixed value of pattern parameter Link, or null if not bound.
	 * @return matches represented as a ActorMappingToTroposSignature object.
	 */
	public Collection<ActorMappingToTroposSignature> getAllMatchesAsObject(Object Actor, Object Link) {
		return getAllMatchesAsObject(new Object[] {Actor, Link});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Link) {
		return getOneMatchAsArray(new Object[] {Actor, Link});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Link the fixed value of pattern parameter Link, or null if not bound.
	 * @return a match represented as a ActorMappingToTroposSignature object, or null if no match is found.
	 */
	public ActorMappingToTroposSignature getOneMatchAsObject(Object Actor, Object Link) {
		return getOneMatchAsObject(new Object[] {Actor, Link});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Link) {
		return hasMatch(new Object[] {Actor, Link});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Link) {
		return countMatches(new Object[] {Actor, Link});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.transform.actorMappingToTropos";
	}

	private static final String[] paramNames = new String[] {"Actor", "Link"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorMappingToTroposSignature tupleToSignature(Tuple t) {
		return new ActorMappingToTroposSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public ActorMappingToTroposSignature arrayToSignature(Object[] signature) {
		return new ActorMappingToTroposSignature(signature[0], signature[1]);
	}	
