/*******************************************************************************
 * EMF Specific API of the secmer.sistar.transform.actorNewToTropos pattern
...
/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.transform.actorNewToTropos pattern
 */
public class ActorNewToTroposMatcher extends BaseGeneratedMatcher<ActorNewToTroposSignature> implements IncQueryMatcher<ActorNewToTroposSignature>{
	 ...
	 */
	public ActorNewToTroposMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNewToTroposMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNewToTroposMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNewToTroposMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * Returns the set of all pattern matches given some fixed parameters.
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @return matches represented as a ActorNewToTroposSignature object.
	 */
	public Collection<ActorNewToTroposSignature> getAllMatchesAsObject(Object Actor) {
	 ...
	 * Neither determinism nor randomness of selection is guaranteed.
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @return a match represented as a ActorNewToTroposSignature object, or null if no match is found.
	 */
	public ActorNewToTroposSignature getOneMatchAsObject(Object Actor) {
	...
	public String getPatternName() {
		return "secmer.sistar.transform.actorNewToTropos";
	}
	 ...
	 */
	@Override
	protected ActorNewToTroposSignature tupleToSignature(Tuple t) {
		return new ActorNewToTroposSignature(t.get(0));
	}
	 ...
	 */
	@Override
	public ActorNewToTroposSignature arrayToSignature(Object[] signature) {
		return new ActorNewToTroposSignature(signature[0]);
	}	
