/*******************************************************************************
 * EMF Specific API of the secmer.sistar.transform.troposReferenceModel pattern
...
import signatures.secmer.sistar.transform.TroposReferenceModelSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.transform.troposReferenceModel pattern
 */
public class TroposReferenceModelMatcher extends BaseGeneratedMatcher<TroposReferenceModelSignature> implements IncQueryMatcher<TroposReferenceModelSignature>{
	 ...
	 */
	public TroposReferenceModelMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public TroposReferenceModelMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public TroposReferenceModelMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public TroposReferenceModelMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param TroposReferenceModel the fixed value of pattern parameter TroposReferenceModel, or null if not bound.
	 * @return matches represented as an array containing the values of each parameter.
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object TroposReferenceModel) {
		return getAllMatchesAsArray(new Object[] {TroposReferenceModel});
	}
	
	/** 
	 * Returns the set of all pattern matches given some fixed parameters.
	 * @param TroposReferenceModel the fixed value of pattern parameter TroposReferenceModel, or null if not bound.
	 * @return matches represented as a TroposReferenceModelSignature object.
	 */
	public Collection<TroposReferenceModelSignature> getAllMatchesAsObject(Object TroposReferenceModel) {
		return getAllMatchesAsObject(new Object[] {TroposReferenceModel});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object TroposReferenceModel) {
		return getOneMatchAsArray(new Object[] {TroposReferenceModel});
	}
	 ...
	 * Neither determinism nor randomness of selection is guaranteed.
	 * @param TroposReferenceModel the fixed value of pattern parameter TroposReferenceModel, or null if not bound.
	 * @return a match represented as a TroposReferenceModelSignature object, or null if no match is found.
	 */
	public TroposReferenceModelSignature getOneMatchAsObject(Object TroposReferenceModel) {
		return getOneMatchAsObject(new Object[] {TroposReferenceModel});
	}
	 ...
	 */
	public boolean hasMatch(Object TroposReferenceModel) {
		return hasMatch(new Object[] {TroposReferenceModel});
	}
	 ...
	 */	
	public int countMatches(Object TroposReferenceModel) {
		return countMatches(new Object[] {TroposReferenceModel});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.transform.troposReferenceModel";
	}

	private static final String[] paramNames = new String[] {"TroposReferenceModel"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected TroposReferenceModelSignature tupleToSignature(Tuple t) {
		return new TroposReferenceModelSignature(t.get(0));
	}
	 ...
	 */
	@Override
	public TroposReferenceModelSignature arrayToSignature(Object[] signature) {
		return new TroposReferenceModelSignature(signature[0]);
	}	
