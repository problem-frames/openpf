/*******************************************************************************
 * EMF Specific API of the secmer.sistar.transform.actorDelFromTropos pattern
...
/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.transform.actorDelFromTropos pattern
 */
public class ActorDelFromTroposMatcher extends BaseGeneratedMatcher<ActorDelFromTroposSignature> implements IncQueryMatcher<ActorDelFromTroposSignature>{
	 ...
	 */
	public ActorDelFromTroposMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorDelFromTroposMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorDelFromTroposMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorDelFromTroposMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Link the fixed value of pattern parameter Link, or null if not bound.
	 * @return matches represented as a ActorDelFromTroposSignature object.
	 */
	public Collection<ActorDelFromTroposSignature> getAllMatchesAsObject(Object Actor, Object Link) {
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Link the fixed value of pattern parameter Link, or null if not bound.
	 * @return a match represented as a ActorDelFromTroposSignature object, or null if no match is found.
	 */
	public ActorDelFromTroposSignature getOneMatchAsObject(Object Actor, Object Link) {
	...
	public String getPatternName() {
		return "secmer.sistar.transform.actorDelFromTropos";
	}
	 ...
	 */
	@Override
	protected ActorDelFromTroposSignature tupleToSignature(Tuple t) {
		return new ActorDelFromTroposSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public ActorDelFromTroposSignature arrayToSignature(Object[] signature) {
		return new ActorDelFromTroposSignature(signature[0], signature[1]);
	}	
