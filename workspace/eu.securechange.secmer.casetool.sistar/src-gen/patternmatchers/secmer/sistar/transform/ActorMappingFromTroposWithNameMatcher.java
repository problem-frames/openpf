/*******************************************************************************
 * EMF Specific API of the secmer.sistar.transform.actorMappingFromTroposWithName pattern
...
import signatures.secmer.sistar.transform.ActorMappingFromTroposWithNameSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.transform.actorMappingFromTroposWithName pattern
 */
public class ActorMappingFromTroposWithNameMatcher extends BaseGeneratedMatcher<ActorMappingFromTroposWithNameSignature> implements IncQueryMatcher<ActorMappingFromTroposWithNameSignature>{
	 ...
	 */
	public ActorMappingFromTroposWithNameMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingFromTroposWithNameMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingFromTroposWithNameMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorMappingFromTroposWithNameMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Link, Object TroposActor, Object Name) {
		return getAllMatchesAsArray(new Object[] {Link, TroposActor, Name});
	}
	 ...
	 * @param TroposActor the fixed value of pattern parameter TroposActor, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return matches represented as a ActorMappingFromTroposWithNameSignature object.
	 */
	public Collection<ActorMappingFromTroposWithNameSignature> getAllMatchesAsObject(Object Link, Object TroposActor, Object Name) {
		return getAllMatchesAsObject(new Object[] {Link, TroposActor, Name});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Link, Object TroposActor, Object Name) {
		return getOneMatchAsArray(new Object[] {Link, TroposActor, Name});
	}
	 ...
	 * @param TroposActor the fixed value of pattern parameter TroposActor, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return a match represented as a ActorMappingFromTroposWithNameSignature object, or null if no match is found.
	 */
	public ActorMappingFromTroposWithNameSignature getOneMatchAsObject(Object Link, Object TroposActor, Object Name) {
		return getOneMatchAsObject(new Object[] {Link, TroposActor, Name});
	}
	 ...
	 */
	public boolean hasMatch(Object Link, Object TroposActor, Object Name) {
		return hasMatch(new Object[] {Link, TroposActor, Name});
	}
	 ...
	 */	
	public int countMatches(Object Link, Object TroposActor, Object Name) {
		return countMatches(new Object[] {Link, TroposActor, Name});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.transform.actorMappingFromTroposWithName";
	}

	private static final String[] paramNames = new String[] {"Link", "TroposActor", "Name"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorMappingFromTroposWithNameSignature tupleToSignature(Tuple t) {
		return new ActorMappingFromTroposWithNameSignature(t.get(0), t.get(1), t.get(2));
	}
	 ...
	 */
	@Override
	public ActorMappingFromTroposWithNameSignature arrayToSignature(Object[] signature) {
		return new ActorMappingFromTroposWithNameSignature(signature[0], signature[1], signature[2]);
	}	
