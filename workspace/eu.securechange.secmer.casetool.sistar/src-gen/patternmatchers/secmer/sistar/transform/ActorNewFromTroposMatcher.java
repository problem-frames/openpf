/*******************************************************************************
 * EMF Specific API of the secmer.sistar.transform.actorNewFromTropos pattern
...
/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.transform.actorNewFromTropos pattern
 */
public class ActorNewFromTroposMatcher extends BaseGeneratedMatcher<ActorNewFromTroposSignature> implements IncQueryMatcher<ActorNewFromTroposSignature>{
	 ...
	 */
	public ActorNewFromTroposMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNewFromTroposMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNewFromTroposMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNewFromTroposMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object TroposActor) {
		return getAllMatchesAsArray(new Object[] {TroposActor});
	}
	
	/** 
	 * Returns the set of all pattern matches given some fixed parameters.
	 * @param TroposActor the fixed value of pattern parameter TroposActor, or null if not bound.
	 * @return matches represented as a ActorNewFromTroposSignature object.
	 */
	public Collection<ActorNewFromTroposSignature> getAllMatchesAsObject(Object TroposActor) {
		return getAllMatchesAsObject(new Object[] {TroposActor});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object TroposActor) {
		return getOneMatchAsArray(new Object[] {TroposActor});
	}
	 ...
	 * Neither determinism nor randomness of selection is guaranteed.
	 * @param TroposActor the fixed value of pattern parameter TroposActor, or null if not bound.
	 * @return a match represented as a ActorNewFromTroposSignature object, or null if no match is found.
	 */
	public ActorNewFromTroposSignature getOneMatchAsObject(Object TroposActor) {
		return getOneMatchAsObject(new Object[] {TroposActor});
	}
	 ...
	 */
	public boolean hasMatch(Object TroposActor) {
		return hasMatch(new Object[] {TroposActor});
	}
	 ...
	 */	
	public int countMatches(Object TroposActor) {
		return countMatches(new Object[] {TroposActor});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.transform.actorNewFromTropos";
	}

	private static final String[] paramNames = new String[] {"TroposActor"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorNewFromTroposSignature tupleToSignature(Tuple t) {
		return new ActorNewFromTroposSignature(t.get(0));
	}
	 ...
	 */
	@Override
	public ActorNewFromTroposSignature arrayToSignature(Object[] signature) {
		return new ActorNewFromTroposSignature(signature[0]);
	}	
