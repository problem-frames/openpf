/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.carryOutDirect pattern
...
import signatures.secmer.sistar.wrap.CarryOutDirectSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.carryOutDirect pattern
 */
public class CarryOutDirectMatcher extends BaseGeneratedMatcher<CarryOutDirectSignature> implements IncQueryMatcher<CarryOutDirectSignature>{
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Action) {
		return getAllMatchesAsArray(new Object[] {Actor, Action});
	}
	 ...
	 */
	public Collection<CarryOutDirectSignature> getAllMatchesAsObject(Object Actor, Object Action) {
		return getAllMatchesAsObject(new Object[] {Actor, Action});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Action) {
		return getOneMatchAsArray(new Object[] {Actor, Action});
	}
	 ...
	 */
	public CarryOutDirectSignature getOneMatchAsObject(Object Actor, Object Action) {
		return getOneMatchAsObject(new Object[] {Actor, Action});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Action) {
		return hasMatch(new Object[] {Actor, Action});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Action) {
		return countMatches(new Object[] {Actor, Action});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.carryOutDirect";
	}

	private static final String[] paramNames = new String[] {"Actor", "Action"};
	/* (non-Javadoc)
