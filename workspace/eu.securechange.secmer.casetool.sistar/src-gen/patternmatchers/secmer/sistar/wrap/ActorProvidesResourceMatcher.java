/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.actorProvidesResource pattern
...
import signatures.secmer.sistar.wrap.ActorProvidesResourceSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.actorProvidesResource pattern
 */
public class ActorProvidesResourceMatcher extends BaseGeneratedMatcher<ActorProvidesResourceSignature> implements IncQueryMatcher<ActorProvidesResourceSignature>{
	 ...
	 */
	public ActorProvidesResourceMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorProvidesResourceMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorProvidesResourceMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorProvidesResourceMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Resource the fixed value of pattern parameter Resource, or null if not bound.
	 * @return matches represented as an array containing the values of each parameter.
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Resource) {
		return getAllMatchesAsArray(new Object[] {Actor, Resource});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Resource the fixed value of pattern parameter Resource, or null if not bound.
	 * @return matches represented as a ActorProvidesResourceSignature object.
	 */
	public Collection<ActorProvidesResourceSignature> getAllMatchesAsObject(Object Actor, Object Resource) {
		return getAllMatchesAsObject(new Object[] {Actor, Resource});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Resource) {
		return getOneMatchAsArray(new Object[] {Actor, Resource});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Resource the fixed value of pattern parameter Resource, or null if not bound.
	 * @return a match represented as a ActorProvidesResourceSignature object, or null if no match is found.
	 */
	public ActorProvidesResourceSignature getOneMatchAsObject(Object Actor, Object Resource) {
		return getOneMatchAsObject(new Object[] {Actor, Resource});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Resource) {
		return hasMatch(new Object[] {Actor, Resource});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Resource) {
		return countMatches(new Object[] {Actor, Resource});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.actorProvidesResource";
	}

	private static final String[] paramNames = new String[] {"Actor", "Resource"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorProvidesResourceSignature tupleToSignature(Tuple t) {
		return new ActorProvidesResourceSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public ActorProvidesResourceSignature arrayToSignature(Object[] signature) {
		return new ActorProvidesResourceSignature(signature[0], signature[1]);
	}	
