/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.actorWantsGoalDirect pattern
...
import signatures.secmer.sistar.wrap.ActorWantsGoalDirectSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.actorWantsGoalDirect pattern
 */
public class ActorWantsGoalDirectMatcher extends BaseGeneratedMatcher<ActorWantsGoalDirectSignature> implements IncQueryMatcher<ActorWantsGoalDirectSignature>{
	 ...
	 */
	public ActorWantsGoalDirectMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorWantsGoalDirectMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorWantsGoalDirectMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorWantsGoalDirectMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Goal) {
		return getAllMatchesAsArray(new Object[] {Actor, Goal});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return matches represented as a ActorWantsGoalDirectSignature object.
	 */
	public Collection<ActorWantsGoalDirectSignature> getAllMatchesAsObject(Object Actor, Object Goal) {
		return getAllMatchesAsObject(new Object[] {Actor, Goal});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Goal) {
		return getOneMatchAsArray(new Object[] {Actor, Goal});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return a match represented as a ActorWantsGoalDirectSignature object, or null if no match is found.
	 */
	public ActorWantsGoalDirectSignature getOneMatchAsObject(Object Actor, Object Goal) {
		return getOneMatchAsObject(new Object[] {Actor, Goal});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Goal) {
		return hasMatch(new Object[] {Actor, Goal});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Goal) {
		return countMatches(new Object[] {Actor, Goal});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.actorWantsGoalDirect";
	}

	private static final String[] paramNames = new String[] {"Actor", "Goal"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorWantsGoalDirectSignature tupleToSignature(Tuple t) {
		return new ActorWantsGoalDirectSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public ActorWantsGoalDirectSignature arrayToSignature(Object[] signature) {
		return new ActorWantsGoalDirectSignature(signature[0], signature[1]);
	}	
