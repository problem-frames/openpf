/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.doDelegation pattern
...
import signatures.secmer.sistar.wrap.DoDelegationSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.doDelegation pattern
 */
public class DoDelegationMatcher extends BaseGeneratedMatcher<DoDelegationSignature> implements IncQueryMatcher<DoDelegationSignature>{
	 ...
	 */
	public Collection<DoDelegationSignature> getAllMatchesAsObject(Object Act1, Object Act2) {
	 ...
	 */
	public DoDelegationSignature getOneMatchAsObject(Object Act1, Object Act2) {
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.doDelegation";
	}
	...
	protected DoDelegationSignature tupleToSignature(Tuple t) {
		return new DoDelegationSignature(t.get(0), t.get(1));
	}
	...
	public DoDelegationSignature arrayToSignature(Object[] signature) {
		return new DoDelegationSignature(signature[0], signature[1]);
	}	
