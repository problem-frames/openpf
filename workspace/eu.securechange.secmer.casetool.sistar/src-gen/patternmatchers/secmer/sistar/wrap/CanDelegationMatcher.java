/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.canDelegation pattern
...
import signatures.secmer.sistar.wrap.CanDelegationSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.canDelegation pattern
 */
public class CanDelegationMatcher extends BaseGeneratedMatcher<CanDelegationSignature> implements IncQueryMatcher<CanDelegationSignature>{
	 ...
	 */
	public CanDelegationMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CanDelegationMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CanDelegationMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CanDelegationMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return matches represented as a CanDelegationSignature object.
	 */
	public Collection<CanDelegationSignature> getAllMatchesAsObject(Object Act1, Object Act2) {
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return a match represented as a CanDelegationSignature object, or null if no match is found.
	 */
	public CanDelegationSignature getOneMatchAsObject(Object Act1, Object Act2) {
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.canDelegation";
	}
	 ...
	 */
	@Override
	protected CanDelegationSignature tupleToSignature(Tuple t) {
		return new CanDelegationSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public CanDelegationSignature arrayToSignature(Object[] signature) {
		return new CanDelegationSignature(signature[0], signature[1]);
	}	
