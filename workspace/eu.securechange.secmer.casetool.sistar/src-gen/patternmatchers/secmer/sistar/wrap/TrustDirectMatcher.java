/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.trustDirect pattern
...
import signatures.secmer.sistar.wrap.TrustDirectSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.trustDirect pattern
 */
public class TrustDirectMatcher extends BaseGeneratedMatcher<TrustDirectSignature> implements IncQueryMatcher<TrustDirectSignature>{
	 ...
	 */
	public TrustDirectMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public TrustDirectMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public TrustDirectMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public TrustDirectMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return matches represented as a TrustDirectSignature object.
	 */
	public Collection<TrustDirectSignature> getAllMatchesAsObject(Object Act1, Object Act2) {
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return a match represented as a TrustDirectSignature object, or null if no match is found.
	 */
	public TrustDirectSignature getOneMatchAsObject(Object Act1, Object Act2) {
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.trustDirect";
	}
	 ...
	 */
	@Override
	protected TrustDirectSignature tupleToSignature(Tuple t) {
		return new TrustDirectSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public TrustDirectSignature arrayToSignature(Object[] signature) {
		return new TrustDirectSignature(signature[0], signature[1]);
	}	
