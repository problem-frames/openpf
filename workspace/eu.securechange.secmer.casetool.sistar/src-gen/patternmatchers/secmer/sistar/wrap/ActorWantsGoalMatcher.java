/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.actorWantsGoal pattern
...
import signatures.secmer.sistar.wrap.ActorWantsGoalSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.actorWantsGoal pattern
 */
public class ActorWantsGoalMatcher extends BaseGeneratedMatcher<ActorWantsGoalSignature> implements IncQueryMatcher<ActorWantsGoalSignature>{
	 ...
	 */
	public ActorWantsGoalMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorWantsGoalMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorWantsGoalMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorWantsGoalMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return matches represented as a ActorWantsGoalSignature object.
	 */
	public Collection<ActorWantsGoalSignature> getAllMatchesAsObject(Object Actor, Object Goal) {
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return a match represented as a ActorWantsGoalSignature object, or null if no match is found.
	 */
	public ActorWantsGoalSignature getOneMatchAsObject(Object Actor, Object Goal) {
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.actorWantsGoal";
	}
	 ...
	 */
	@Override
	protected ActorWantsGoalSignature tupleToSignature(Tuple t) {
		return new ActorWantsGoalSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public ActorWantsGoalSignature arrayToSignature(Object[] signature) {
		return new ActorWantsGoalSignature(signature[0], signature[1]);
	}	
