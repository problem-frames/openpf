/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.actorName pattern
...
import signatures.secmer.sistar.wrap.ActorNameSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.actorName pattern
 */
public class ActorNameMatcher extends BaseGeneratedMatcher<ActorNameSignature> implements IncQueryMatcher<ActorNameSignature>{
	 ...
	 */
	public ActorNameMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNameMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNameMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorNameMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Name) {
		return getAllMatchesAsArray(new Object[] {Actor, Name});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return matches represented as a ActorNameSignature object.
	 */
	public Collection<ActorNameSignature> getAllMatchesAsObject(Object Actor, Object Name) {
		return getAllMatchesAsObject(new Object[] {Actor, Name});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Name) {
		return getOneMatchAsArray(new Object[] {Actor, Name});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return a match represented as a ActorNameSignature object, or null if no match is found.
	 */
	public ActorNameSignature getOneMatchAsObject(Object Actor, Object Name) {
		return getOneMatchAsObject(new Object[] {Actor, Name});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Name) {
		return hasMatch(new Object[] {Actor, Name});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Name) {
		return countMatches(new Object[] {Actor, Name});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.actorName";
	}

	private static final String[] paramNames = new String[] {"Actor", "Name"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorNameSignature tupleToSignature(Tuple t) {
		return new ActorNameSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public ActorNameSignature arrayToSignature(Object[] signature) {
		return new ActorNameSignature(signature[0], signature[1]);
	}	
