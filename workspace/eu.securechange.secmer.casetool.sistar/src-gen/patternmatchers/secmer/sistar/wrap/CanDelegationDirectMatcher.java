/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.canDelegationDirect pattern
...
import signatures.secmer.sistar.wrap.CanDelegationDirectSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.canDelegationDirect pattern
 */
public class CanDelegationDirectMatcher extends BaseGeneratedMatcher<CanDelegationDirectSignature> implements IncQueryMatcher<CanDelegationDirectSignature>{
	 ...
	 */
	public CanDelegationDirectMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CanDelegationDirectMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CanDelegationDirectMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CanDelegationDirectMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return matches represented as a CanDelegationDirectSignature object.
	 */
	public Collection<CanDelegationDirectSignature> getAllMatchesAsObject(Object Act1, Object Act2) {
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return a match represented as a CanDelegationDirectSignature object, or null if no match is found.
	 */
	public CanDelegationDirectSignature getOneMatchAsObject(Object Act1, Object Act2) {
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.canDelegationDirect";
	}
	 ...
	 */
	@Override
	protected CanDelegationDirectSignature tupleToSignature(Tuple t) {
		return new CanDelegationDirectSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public CanDelegationDirectSignature arrayToSignature(Object[] signature) {
		return new CanDelegationDirectSignature(signature[0], signature[1]);
	}	
