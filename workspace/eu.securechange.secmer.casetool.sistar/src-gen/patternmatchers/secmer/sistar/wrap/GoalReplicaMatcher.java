/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.goalReplica pattern
...
import signatures.secmer.sistar.wrap.GoalReplicaSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.goalReplica pattern
 */
public class GoalReplicaMatcher extends BaseGeneratedMatcher<GoalReplicaSignature> implements IncQueryMatcher<GoalReplicaSignature>{
	 ...
	 */
	public GoalReplicaMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public GoalReplicaMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public GoalReplicaMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public GoalReplicaMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param G1 the fixed value of pattern parameter G1, or null if not bound.
	 * @param G2 the fixed value of pattern parameter G2, or null if not bound.
	 * @return matches represented as an array containing the values of each parameter.
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object G1, Object G2) {
		return getAllMatchesAsArray(new Object[] {G1, G2});
	}
	 ...
	 * @param G1 the fixed value of pattern parameter G1, or null if not bound.
	 * @param G2 the fixed value of pattern parameter G2, or null if not bound.
	 * @return matches represented as a GoalReplicaSignature object.
	 */
	public Collection<GoalReplicaSignature> getAllMatchesAsObject(Object G1, Object G2) {
		return getAllMatchesAsObject(new Object[] {G1, G2});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object G1, Object G2) {
		return getOneMatchAsArray(new Object[] {G1, G2});
	}
	 ...
	 * @param G1 the fixed value of pattern parameter G1, or null if not bound.
	 * @param G2 the fixed value of pattern parameter G2, or null if not bound.
	 * @return a match represented as a GoalReplicaSignature object, or null if no match is found.
	 */
	public GoalReplicaSignature getOneMatchAsObject(Object G1, Object G2) {
		return getOneMatchAsObject(new Object[] {G1, G2});
	}
	 ...
	 */
	public boolean hasMatch(Object G1, Object G2) {
		return hasMatch(new Object[] {G1, G2});
	}
	 ...
	 */	
	public int countMatches(Object G1, Object G2) {
		return countMatches(new Object[] {G1, G2});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.goalReplica";
	}

	private static final String[] paramNames = new String[] {"G1", "G2"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected GoalReplicaSignature tupleToSignature(Tuple t) {
		return new GoalReplicaSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public GoalReplicaSignature arrayToSignature(Object[] signature) {
		return new GoalReplicaSignature(signature[0], signature[1]);
	}	
