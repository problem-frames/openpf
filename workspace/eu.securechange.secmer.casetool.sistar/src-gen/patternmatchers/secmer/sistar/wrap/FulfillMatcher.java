/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.fulfill pattern
...
import signatures.secmer.sistar.wrap.FulfillSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.fulfill pattern
 */
public class FulfillMatcher extends BaseGeneratedMatcher<FulfillSignature> implements IncQueryMatcher<FulfillSignature>{
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Process, Object Goal) {
		return getAllMatchesAsArray(new Object[] {Process, Goal});
	}
	 ...
	 */
	public Collection<FulfillSignature> getAllMatchesAsObject(Object Process, Object Goal) {
		return getAllMatchesAsObject(new Object[] {Process, Goal});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Process, Object Goal) {
		return getOneMatchAsArray(new Object[] {Process, Goal});
	}
	 ...
	 */
	public FulfillSignature getOneMatchAsObject(Object Process, Object Goal) {
		return getOneMatchAsObject(new Object[] {Process, Goal});
	}
	 ...
	 */
	public boolean hasMatch(Object Process, Object Goal) {
		return hasMatch(new Object[] {Process, Goal});
	}
	 ...
	 */	
	public int countMatches(Object Process, Object Goal) {
		return countMatches(new Object[] {Process, Goal});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.fulfill";
	}

	private static final String[] paramNames = new String[] {"Process", "Goal"};
	/* (non-Javadoc)
