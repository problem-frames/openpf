/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.doDelegationDirect pattern
...
import signatures.secmer.sistar.wrap.DoDelegationDirectSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.doDelegationDirect pattern
 */
public class DoDelegationDirectMatcher extends BaseGeneratedMatcher<DoDelegationDirectSignature> implements IncQueryMatcher<DoDelegationDirectSignature>{
	 ...
	 */
	public DoDelegationDirectMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DoDelegationDirectMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DoDelegationDirectMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DoDelegationDirectMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return matches represented as a DoDelegationDirectSignature object.
	 */
	public Collection<DoDelegationDirectSignature> getAllMatchesAsObject(Object Act1, Object Act2) {
	 ...
	 * @param Act1 the fixed value of pattern parameter Act1, or null if not bound.
	 * @param Act2 the fixed value of pattern parameter Act2, or null if not bound.
	 * @return a match represented as a DoDelegationDirectSignature object, or null if no match is found.
	 */
	public DoDelegationDirectSignature getOneMatchAsObject(Object Act1, Object Act2) {
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.doDelegationDirect";
	}
	 ...
	 */
	@Override
	protected DoDelegationDirectSignature tupleToSignature(Tuple t) {
		return new DoDelegationDirectSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public DoDelegationDirectSignature arrayToSignature(Object[] signature) {
		return new DoDelegationDirectSignature(signature[0], signature[1]);
	}	
