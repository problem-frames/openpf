/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.carryOut pattern
...
import signatures.secmer.sistar.wrap.CarryOutSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.carryOut pattern
 */
public class CarryOutMatcher extends BaseGeneratedMatcher<CarryOutSignature> implements IncQueryMatcher<CarryOutSignature>{
	 ...
	 */
	public CarryOutMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CarryOutMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CarryOutMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public CarryOutMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Process) {
		return getAllMatchesAsArray(new Object[] {Actor, Process});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Process the fixed value of pattern parameter Process, or null if not bound.
	 * @return matches represented as a CarryOutSignature object.
	 */
	public Collection<CarryOutSignature> getAllMatchesAsObject(Object Actor, Object Process) {
		return getAllMatchesAsObject(new Object[] {Actor, Process});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Process) {
		return getOneMatchAsArray(new Object[] {Actor, Process});
	}
	 ...
	 * @param Actor the fixed value of pattern parameter Actor, or null if not bound.
	 * @param Process the fixed value of pattern parameter Process, or null if not bound.
	 * @return a match represented as a CarryOutSignature object, or null if no match is found.
	 */
	public CarryOutSignature getOneMatchAsObject(Object Actor, Object Process) {
		return getOneMatchAsObject(new Object[] {Actor, Process});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Process) {
		return hasMatch(new Object[] {Actor, Process});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Process) {
		return countMatches(new Object[] {Actor, Process});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.carryOut";
	}

	private static final String[] paramNames = new String[] {"Actor", "Process"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected CarryOutSignature tupleToSignature(Tuple t) {
		return new CarryOutSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public CarryOutSignature arrayToSignature(Object[] signature) {
		return new CarryOutSignature(signature[0], signature[1]);
	}	
