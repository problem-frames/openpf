/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.decomposeDirectAND pattern
...
import signatures.secmer.sistar.wrap.DecomposeDirectANDSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.decomposeDirectAND pattern
 */
public class DecomposeDirectANDMatcher extends BaseGeneratedMatcher<DecomposeDirectANDSignature> implements IncQueryMatcher<DecomposeDirectANDSignature>{
	 ...
	 */
	public DecomposeDirectANDMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DecomposeDirectANDMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DecomposeDirectANDMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public DecomposeDirectANDMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 * @param Parent the fixed value of pattern parameter Parent, or null if not bound.
	 * @param Child the fixed value of pattern parameter Child, or null if not bound.
	 * @return matches represented as a DecomposeDirectANDSignature object.
	 */
	public Collection<DecomposeDirectANDSignature> getAllMatchesAsObject(Object Parent, Object Child) {
	 ...
	 * @param Parent the fixed value of pattern parameter Parent, or null if not bound.
	 * @param Child the fixed value of pattern parameter Child, or null if not bound.
	 * @return a match represented as a DecomposeDirectANDSignature object, or null if no match is found.
	 */
	public DecomposeDirectANDSignature getOneMatchAsObject(Object Parent, Object Child) {
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.decomposeDirectAND";
	}
	 ...
	 */
	@Override
	protected DecomposeDirectANDSignature tupleToSignature(Tuple t) {
		return new DecomposeDirectANDSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public DecomposeDirectANDSignature arrayToSignature(Object[] signature) {
		return new DecomposeDirectANDSignature(signature[0], signature[1]);
	}	
