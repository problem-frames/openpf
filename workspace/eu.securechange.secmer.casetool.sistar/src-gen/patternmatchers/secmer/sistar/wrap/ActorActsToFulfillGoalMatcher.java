/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.actorActsToFulfillGoal pattern
...
import signatures.secmer.sistar.wrap.ActorActsToFulfillGoalSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.actorActsToFulfillGoal pattern
 */
public class ActorActsToFulfillGoalMatcher extends BaseGeneratedMatcher<ActorActsToFulfillGoalSignature> implements IncQueryMatcher<ActorActsToFulfillGoalSignature>{
	 ...
	 */
	public ActorActsToFulfillGoalMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorActsToFulfillGoalMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorActsToFulfillGoalMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public ActorActsToFulfillGoalMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Actor, Object Action, Object Goal) {
		return getAllMatchesAsArray(new Object[] {Actor, Action, Goal});
	}
	 ...
	 * @param Action the fixed value of pattern parameter Action, or null if not bound.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return matches represented as a ActorActsToFulfillGoalSignature object.
	 */
	public Collection<ActorActsToFulfillGoalSignature> getAllMatchesAsObject(Object Actor, Object Action, Object Goal) {
		return getAllMatchesAsObject(new Object[] {Actor, Action, Goal});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Actor, Object Action, Object Goal) {
		return getOneMatchAsArray(new Object[] {Actor, Action, Goal});
	}
	 ...
	 * @param Action the fixed value of pattern parameter Action, or null if not bound.
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @return a match represented as a ActorActsToFulfillGoalSignature object, or null if no match is found.
	 */
	public ActorActsToFulfillGoalSignature getOneMatchAsObject(Object Actor, Object Action, Object Goal) {
		return getOneMatchAsObject(new Object[] {Actor, Action, Goal});
	}
	 ...
	 */
	public boolean hasMatch(Object Actor, Object Action, Object Goal) {
		return hasMatch(new Object[] {Actor, Action, Goal});
	}
	 ...
	 */	
	public int countMatches(Object Actor, Object Action, Object Goal) {
		return countMatches(new Object[] {Actor, Action, Goal});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.actorActsToFulfillGoal";
	}

	private static final String[] paramNames = new String[] {"Actor", "Action", "Goal"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected ActorActsToFulfillGoalSignature tupleToSignature(Tuple t) {
		return new ActorActsToFulfillGoalSignature(t.get(0), t.get(1), t.get(2));
	}
	 ...
	 */
	@Override
	public ActorActsToFulfillGoalSignature arrayToSignature(Object[] signature) {
		return new ActorActsToFulfillGoalSignature(signature[0], signature[1], signature[2]);
	}	
