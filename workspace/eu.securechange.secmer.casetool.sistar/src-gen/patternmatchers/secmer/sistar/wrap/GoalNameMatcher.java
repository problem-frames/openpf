/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.goalName pattern
...
import signatures.secmer.sistar.wrap.GoalNameSignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.goalName pattern
 */
public class GoalNameMatcher extends BaseGeneratedMatcher<GoalNameSignature> implements IncQueryMatcher<GoalNameSignature>{
	 ...
	 */
	public GoalNameMatcher(Notifier emfRoot, int numThreads) 
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public GoalNameMatcher(Notifier emfRoot) 
			throws ViatraCompiledRuntimeException {
		super(emfRoot);
	}
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public GoalNameMatcher(TransactionalEditingDomain trDomain, int numThreads) 
			throws ViatraCompiledRuntimeException {
	 ...
	 * @throws ViatraCompiledRuntimeException if an error occurs during pattern matcher creation
	 */
	public GoalNameMatcher(TransactionalEditingDomain trDomain)
			throws ViatraCompiledRuntimeException {
		super(trDomain);
	}
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Goal, Object Name) {
		return getAllMatchesAsArray(new Object[] {Goal, Name});
	}
	 ...
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return matches represented as a GoalNameSignature object.
	 */
	public Collection<GoalNameSignature> getAllMatchesAsObject(Object Goal, Object Name) {
		return getAllMatchesAsObject(new Object[] {Goal, Name});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Goal, Object Name) {
		return getOneMatchAsArray(new Object[] {Goal, Name});
	}
	 ...
	 * @param Goal the fixed value of pattern parameter Goal, or null if not bound.
	 * @param Name the fixed value of pattern parameter Name, or null if not bound.
	 * @return a match represented as a GoalNameSignature object, or null if no match is found.
	 */
	public GoalNameSignature getOneMatchAsObject(Object Goal, Object Name) {
		return getOneMatchAsObject(new Object[] {Goal, Name});
	}
	 ...
	 */
	public boolean hasMatch(Object Goal, Object Name) {
		return hasMatch(new Object[] {Goal, Name});
	}
	 ...
	 */	
	public int countMatches(Object Goal, Object Name) {
		return countMatches(new Object[] {Goal, Name});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.goalName";
	}

	private static final String[] paramNames = new String[] {"Goal", "Name"};
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected GoalNameSignature tupleToSignature(Tuple t) {
		return new GoalNameSignature(t.get(0), t.get(1));
	}
	 ...
	 */
	@Override
	public GoalNameSignature arrayToSignature(Object[] signature) {
		return new GoalNameSignature(signature[0], signature[1]);
	}	
