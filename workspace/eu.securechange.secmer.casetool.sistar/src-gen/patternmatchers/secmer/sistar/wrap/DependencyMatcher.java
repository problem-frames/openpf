/*******************************************************************************
 * EMF Specific API of the secmer.sistar.wrap.dependency pattern
...
import signatures.secmer.sistar.wrap.DependencySignature;

/**
 * Generated domain-specific pattern matcher API of of the secmer.sistar.wrap.dependency pattern
 */
public class DependencyMatcher extends BaseGeneratedMatcher<DependencySignature> implements IncQueryMatcher<DependencySignature>{
	 ...
	 */
	public Collection<Object[]> getAllMatchesAsArray(Object Act1, Object Act2, Object DependencyType) {
		return getAllMatchesAsArray(new Object[] {Act1, Act2, DependencyType});
	}
	 ...
	 */
	public Collection<DependencySignature> getAllMatchesAsObject(Object Act1, Object Act2, Object DependencyType) {
		return getAllMatchesAsObject(new Object[] {Act1, Act2, DependencyType});
	}
	 ...
	 */
	public Object[] getOneMatchAsArray(Object Act1, Object Act2, Object DependencyType) {
		return getOneMatchAsArray(new Object[] {Act1, Act2, DependencyType});
	}
	 ...
	 */
	public DependencySignature getOneMatchAsObject(Object Act1, Object Act2, Object DependencyType) {
		return getOneMatchAsObject(new Object[] {Act1, Act2, DependencyType});
	}
	 ...
	 */
	public boolean hasMatch(Object Act1, Object Act2, Object DependencyType) {
		return hasMatch(new Object[] {Act1, Act2, DependencyType});
	}
	 ...
	 */	
	public int countMatches(Object Act1, Object Act2, Object DependencyType) {
		return countMatches(new Object[] {Act1, Act2, DependencyType});
	}
	...
	public String getPatternName() {
		return "secmer.sistar.wrap.dependency";
	}

	private static final String[] paramNames = new String[] {"Act1", "Act2", "DependencyType"};
	/* (non-Javadoc)
	...
	protected DependencySignature tupleToSignature(Tuple t) {
		return new DependencySignature(t.get(0), t.get(1), t.get(2));
	}
	...
	public DependencySignature arrayToSignature(Object[] signature) {
		return new DependencySignature(signature[0], signature[1], signature[2]);
	}	
