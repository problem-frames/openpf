/*******************************************************************************
 * EMF Specific pattern signature of the secmer.sistar.transform.actorDelFromTropos pattern
...
/**
 * Domain specific Data transfer Object of the secmer.sistar.transform.actorDelFromTropos pattern.
 ...
 */
public class ActorDelFromTroposSignature implements IPatternSignature {

	//constructor
	public ActorDelFromTroposSignature(Object Actor, Object Link) {
		this.Actor = Actor;
		this.Link = Link;	
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ActorDelFromTroposSignature other = (ActorDelFromTroposSignature) obj;
	...
	public String toString(){
		...
		String _temp = " A(n) actorDelFromTropos signature object ("+hashCode()+")\n";
