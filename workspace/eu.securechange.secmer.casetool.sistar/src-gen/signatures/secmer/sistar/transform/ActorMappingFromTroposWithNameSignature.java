/*******************************************************************************
 * EMF Specific pattern signature of the secmer.sistar.transform.actorMappingFromTroposWithName pattern
...
/**
 * Domain specific Data transfer Object of the secmer.sistar.transform.actorMappingFromTroposWithName pattern.
 ...
 */
public class ActorMappingFromTroposWithNameSignature implements IPatternSignature {

	//constructor
	public ActorMappingFromTroposWithNameSignature(Object Link, Object TroposActor, Object Name) {
		this.Link = Link;
	...
	//private attributes
	private Object Link;	private Object TroposActor;	private Object Name;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ActorMappingFromTroposWithNameSignature other = (ActorMappingFromTroposWithNameSignature) obj;
	...
	public String toString(){
		...
		String _temp = " A(n) actorMappingFromTroposWithName signature object ("+hashCode()+")\n";
	...
	public Object[] toArray() {
		return new Object[] {Link, TroposActor, Name};
	}
}
