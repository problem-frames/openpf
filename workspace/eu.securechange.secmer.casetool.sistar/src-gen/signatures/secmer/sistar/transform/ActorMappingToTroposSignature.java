/*******************************************************************************
 * EMF Specific pattern signature of the secmer.sistar.transform.actorMappingToTropos pattern
...
/**
 * Domain specific Data transfer Object of the secmer.sistar.transform.actorMappingToTropos pattern.
 ...
 */
public class ActorMappingToTroposSignature implements IPatternSignature {

	//constructor
	public ActorMappingToTroposSignature(Object Actor, Object Link) {
		this.Actor = Actor;
		this.Link = Link;	
	}

	//private attributes
	private Object Actor;	private Object Link;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ActorMappingToTroposSignature other = (ActorMappingToTroposSignature) obj;
	...
	public String toString(){
		...
		String _temp = " A(n) actorMappingToTropos signature object ("+hashCode()+")\n";
