/*******************************************************************************
 * EMF Specific pattern signature of the secmer.sistar.transform.actorMappingToTroposWithName pattern
...
/**
 * Domain specific Data transfer Object of the secmer.sistar.transform.actorMappingToTroposWithName pattern.
 ...
 */
public class ActorMappingToTroposWithNameSignature implements IPatternSignature {

	//constructor
	public ActorMappingToTroposWithNameSignature(Object Actor, Object Link, Object Name) {
		this.Actor = Actor;
		this.Link = Link;
		this.Name = Name;	
	}
	...
	//private attributes
	private Object Actor;	private Object Link;	private Object Name;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ActorMappingToTroposWithNameSignature other = (ActorMappingToTroposWithNameSignature) obj;
	...
	public String toString(){
		...
		String _temp = " A(n) actorMappingToTroposWithName signature object ("+hashCode()+")\n";
	...
	public Object[] toArray() {
		return new Object[] {Actor, Link, Name};
	}
}
