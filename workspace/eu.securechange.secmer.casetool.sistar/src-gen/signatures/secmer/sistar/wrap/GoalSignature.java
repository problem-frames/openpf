/*******************************************************************************
 * EMF Specific pattern signature of the secmer.sistar.wrap.goal pattern
...
/**
 * Domain specific Data transfer Object of the secmer.sistar.wrap.goal pattern.
 ...
 */
public class GoalSignature implements IPatternSignature {

	//constructor
	public GoalSignature(Object Goal) {
		this.Goal = Goal;	
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GoalSignature other = (GoalSignature) obj;
	...
	public String toString(){
		...
		String _temp = " A(n) goal signature object ("+hashCode()+")\n";
