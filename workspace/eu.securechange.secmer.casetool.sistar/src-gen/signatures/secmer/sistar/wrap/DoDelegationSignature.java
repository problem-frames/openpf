/*******************************************************************************
 * EMF Specific pattern signature of the secmer.sistar.wrap.doDelegation pattern
...
/**
 * Domain specific Data transfer Object of the secmer.sistar.wrap.doDelegation pattern.
...
public class DoDelegationSignature implements IPatternSignature {
	...
	//constructor
	public DoDelegationSignature(Object Act1, Object Act2) {
		this.Act1 = Act1;
		this.Act2 = Act2;	
	}
