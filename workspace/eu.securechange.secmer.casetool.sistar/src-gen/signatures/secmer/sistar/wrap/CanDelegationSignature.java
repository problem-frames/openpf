/*******************************************************************************
 * EMF Specific pattern signature of the secmer.sistar.wrap.canDelegation pattern
...
/**
 * Domain specific Data transfer Object of the secmer.sistar.wrap.canDelegation pattern.
...
public class CanDelegationSignature implements IPatternSignature {
	...
	//constructor
	public CanDelegationSignature(Object Act1, Object Act2) {
		this.Act1 = Act1;
		this.Act2 = Act2;	
	}
