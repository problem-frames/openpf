...
/**
 * This is the item provider adapter for a {@link argument.argument.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ArgumentPackage.Literals.LINK__FROM,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ArgumentPackage.Literals.LINK__TO,
         true,
         false,
         true,
         null,
  ...
  protected void addGeneratedPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Link_generated_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Link_generated_feature", "_UI_Link_type"),
         ArgumentPackage.Literals.LINK__GENERATED,
         true,
         false,
         false,
  ...
  public String getText(Object object)
  {
    ...
    return getString("_UI_Link_type") + " " + link.isGenerated();
  }
