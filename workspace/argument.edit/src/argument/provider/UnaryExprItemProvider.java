...
/**
 * This is the item provider adapter for a {@link argument.argument.UnaryExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryExprItemProvider
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_UnaryExpr_uop_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_UnaryExpr_uop_feature", "_UI_UnaryExpr_type"),
         ArgumentPackage.Literals.UNARY_EXPR__UOP,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ArgumentPackage.Literals.UNARY_EXPR__RIGHT);
    }
  ...
  {
    UnaryOp labelValue = ((UnaryExpr)object).getUop();
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ArgumentPackage.Literals.UNARY_EXPR__RIGHT,
         ArgumentFactory.eINSTANCE.createPrePrimaryExpr()));
