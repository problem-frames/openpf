...
/**
 * This is the item provider adapter for a {@link argument.argument.Mitigates} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MitigatesItemProvider
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public MitigatesItemProvider(AdapterFactory adapterFactory)
  {
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/Mitigates"));
  }
  ...
  {
    Mitigates mitigates = (Mitigates)object;
    return getString("_UI_Mitigates_type") + " " + mitigates.isGenerated();
  }
