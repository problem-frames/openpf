...
/**
 * This is the item provider adapter for a {@link argument.argument.Div} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DivItemProvider
	extends MultiplicationItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Div_mul_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Div_mul_op_feature", "_UI_Div_type"),
				 ArgumentPackage.Literals.DIV__MUL_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArgumentPackage.Literals.DIV__LEFT);
			childrenFeatures.add(ArgumentPackage.Literals.DIV__RIGHT);
		}
	...
	public String getText(Object object) {
		String label = ((Div)object).getMul_op();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArgumentPackage.Literals.DIV__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(ArgumentPackage.Literals.DIV__RIGHT,
				 ArgumentFactory.eINSTANCE.createPower()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ArgumentPackage.Literals.DIV__LEFT ||
			childFeature == ArgumentPackage.Literals.DIV__RIGHT;
