...
/**
 * This is the item provider adapter for a {@link argument.argument.Plus} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlusItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Plus_add_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Plus_add_op_feature", "_UI_Plus_type"),
				 ArgumentPackage.Literals.PLUS__ADD_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArgumentPackage.Literals.PLUS__LEFT);
			childrenFeatures.add(ArgumentPackage.Literals.PLUS__RIGHT);
		}
	...
	public String getText(Object object) {
		String label = ((Plus)object).getAdd_op();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArgumentPackage.Literals.PLUS__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(ArgumentPackage.Literals.PLUS__RIGHT,
				 ArgumentFactory.eINSTANCE.createMultiplication()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ArgumentPackage.Literals.PLUS__LEFT ||
			childFeature == ArgumentPackage.Literals.PLUS__RIGHT;
