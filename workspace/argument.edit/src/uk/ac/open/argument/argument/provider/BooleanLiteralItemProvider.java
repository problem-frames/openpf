...
/**
 * This is the item provider adapter for a {@link uk.ac.open.argument.argument.BooleanLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanLiteralItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArgumentPackage.Literals.BOOLEAN_LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		UnaryOp labelValue = ((BooleanLiteral)object).getOp();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanLiteral.class)) {
			case ArgumentPackage.BOOLEAN_LITERAL__VALUE:
