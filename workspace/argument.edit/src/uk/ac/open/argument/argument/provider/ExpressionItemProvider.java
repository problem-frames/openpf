...
public class ExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expression_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Expression_op_feature", "_UI_Expression_type"),
				 ArgumentPackage.Literals.EXPRESSION__OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArgumentPackage.Literals.EXPRESSION__EXPR);
	...
	public String getText(Object object) {
		UnaryOp labelValue = ((Expression)object).getOp();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArgumentPackage.Literals.EXPRESSION__EXPR,
