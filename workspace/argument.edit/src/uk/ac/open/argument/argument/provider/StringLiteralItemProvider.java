...
/**
 * This is the item provider adapter for a {@link uk.ac.open.argument.argument.StringLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringLiteralItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArgumentPackage.Literals.STRING_LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		UnaryOp labelValue = ((StringLiteral)object).getOp();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringLiteral.class)) {
			case ArgumentPackage.STRING_LITERAL__VALUE:
