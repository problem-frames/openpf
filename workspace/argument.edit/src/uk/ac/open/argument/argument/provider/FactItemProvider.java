...
/**
 * This is the item provider adapter for a {@link uk.ac.open.argument.argument.Fact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FactItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fact_origin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fact_origin_feature", "_UI_Fact_type"),
				 ArgumentPackage.Literals.FACT__ORIGIN,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Fact)object).getName();
