...
/**
 * This is the item provider adapter for a {@link uk.ac.open.argument.argument.ArgumentDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentDiagramItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArgumentDiagram_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArgumentDiagram_name_feature", "_UI_ArgumentDiagram_type"),
				 ArgumentPackage.Literals.ARGUMENT_DIAGRAM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArgumentPackage.Literals.ARGUMENT_DIAGRAM__NODES);
			childrenFeatures.add(ArgumentPackage.Literals.ARGUMENT_DIAGRAM__LINKS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ArgumentDiagram"));
	}
	...
	public String getText(Object object) {
		String label = ((ArgumentDiagram)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ArgumentDiagram_type") :
			getString("_UI_ArgumentDiagram_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArgumentPackage.Literals.ARGUMENT_DIAGRAM__LINKS,
				 ArgumentFactory.eINSTANCE.createRebuts()));

		newChildDescriptors.add
			(createChildParameter
				(ArgumentPackage.Literals.ARGUMENT_DIAGRAM__LINKS,
				 ArgumentFactory.eINSTANCE.createMitigates()));
	}
