 ...
 * @generated
 */
public class SecMERToolSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SecMERToolPackage.SEC_MER_INTEGRATION_MODEL: {
				SecMERIntegrationModel secMERIntegrationModel = (SecMERIntegrationModel)theEObject;
				T result = caseSecMERIntegrationModel(secMERIntegrationModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SecMERToolPackage.REFERENCE_MODEL: {
				ReferenceModel referenceModel = (ReferenceModel)theEObject;
				T result = caseReferenceModel(referenceModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SecMERToolPackage.REFERENCE_LINK: {
				ReferenceLink referenceLink = (ReferenceLink)theEObject;
				T result = caseReferenceLink(referenceLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SecMERToolPackage.NAMED_REFERENCE_LINK: {
				NamedReferenceLink namedReferenceLink = (NamedReferenceLink)theEObject;
				T result = caseNamedReferenceLink(namedReferenceLink);
				if (result == null) result = caseReferenceLink(namedReferenceLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sec MER Integration Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sec MER Integration Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSecMERIntegrationModel(SecMERIntegrationModel object) {
		return null;
	}
