...
/**
 * This is the item provider adapter for a {@link eu.securechange.ontology.ontology.Situation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SituationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Situation_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Situation_time_feature", "_UI_Situation_type"),
				 OntologyPackage.Literals.SITUATION__TIME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OntologyPackage.Literals.SITUATION__WORLD);
		}
	...
	public String getText(Object object) {
		String label = ((Situation)object).getTime();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.SITUATION__WORLD,
				 OntologyFactory.eINSTANCE.createWorld()));
	}
