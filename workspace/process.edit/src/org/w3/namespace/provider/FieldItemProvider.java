...
/**
 * This is the item provider adapter for a {@link org.w3.namespace.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_kind_feature", "_UI_Field_type"),
				 NamespacePackage.Literals.FIELD__KIND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamespacePackage.Literals.FIELD__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NamespacePackage.Literals.FIELD__MIXED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.FIELD__MIXED,
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.FIELD__MIXED,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.FIELD__AGGREGATE,
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.FIELD__MIXED,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.FIELD__NULL_AGGREGATE,
