...
/**
 * This is the item provider adapter for a {@link org.w3.namespace.Aggregate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AggregateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Aggregate_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Aggregate_type_feature", "_UI_Aggregate_type"),
				 NamespacePackage.Literals.AGGREGATE__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NamespacePackage.Literals.AGGREGATE__GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((Aggregate)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Aggregate.class)) {
			case NamespacePackage.AGGREGATE__TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case NamespacePackage.AGGREGATE__GROUP:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.AGGREGATE__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.AGGREGATE__FIELD,
