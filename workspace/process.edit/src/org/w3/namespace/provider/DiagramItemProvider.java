...
/**
 * This is the item provider adapter for a {@link org.w3.namespace.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamespacePackage.Literals.DIAGRAM__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamespacePackage.Literals.DIAGRAM__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NamespacePackage.Literals.DIAGRAM__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.DIAGRAM__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.DIAGRAM__POST_IT,
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.DIAGRAM__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.DIAGRAM__LOCATION,
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.DIAGRAM__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.DIAGRAM__TAGGED_LOCATION,
