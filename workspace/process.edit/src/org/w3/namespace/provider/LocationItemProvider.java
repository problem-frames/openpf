...
/**
 * This is the item provider adapter for a {@link org.w3.namespace.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamespacePackage.Literals.LOCATION__ID,
				 true,
				 false,
				 false,
	...
	protected void addKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_key_feature", "_UI_Location_type"),
				 NamespacePackage.Literals.LOCATION__KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addXPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_xPosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_xPosition_feature", "_UI_Location_type"),
				 NamespacePackage.Literals.LOCATION__XPOSITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addYPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_yPosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_yPosition_feature", "_UI_Location_type"),
				 NamespacePackage.Literals.LOCATION__YPOSITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
