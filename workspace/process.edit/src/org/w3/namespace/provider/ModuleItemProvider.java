...
/**
 * This is the item provider adapter for a {@link org.w3.namespace.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Module_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Module_id_feature", "_UI_Module_type"),
				 NamespacePackage.Literals.MODULE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NamespacePackage.Literals.MODULE__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.MODULE__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.MODULE__IMPORT,
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.MODULE__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.MODULE__EXPORT,
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.MODULE__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.MODULE__STEP_DECLARATION,
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.MODULE__GROUP,
				 FeatureMapUtil.createEntry
					(NamespacePackage.Literals.MODULE__STEP_REFERENCE,
