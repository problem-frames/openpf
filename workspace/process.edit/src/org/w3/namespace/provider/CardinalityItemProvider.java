...
/**
 * This is the item provider adapter for a {@link org.w3.namespace.Cardinality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CardinalityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cardinality_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cardinality_id_feature", "_UI_Cardinality_type"),
				 NamespacePackage.Literals.CARDINALITY__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamespacePackage.Literals.CARDINALITY__LOWER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamespacePackage.Literals.CARDINALITY__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NamespacePackage.Literals.CARDINALITY__CONTROL_PARAMETER);
			childrenFeatures.add(NamespacePackage.Literals.CARDINALITY__PREDICATE_EXPRESSION);
		}
	...
	public String getText(Object object) {
		String label = ((Cardinality)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.CARDINALITY__CONTROL_PARAMETER,
				 NamespaceFactory.eINSTANCE.createControlParameter()));

		newChildDescriptors.add
			(createChildParameter
				(NamespacePackage.Literals.CARDINALITY__PREDICATE_EXPRESSION,
