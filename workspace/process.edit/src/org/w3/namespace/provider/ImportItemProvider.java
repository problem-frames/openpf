...
/**
 * This is the item provider adapter for a {@link org.w3.namespace.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamespacePackage.Literals.IMPORT__ID,
				 true,
				 false,
				 false,
	...
	protected void addStepNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_stepName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_stepName_feature", "_UI_Import_type"),
				 NamespacePackage.Literals.IMPORT__STEP_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
